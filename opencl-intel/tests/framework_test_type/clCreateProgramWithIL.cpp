...
TEST_F(CL21, CreateProgramWithIL_IL_VERSION) {
  ...
  iRet = clGetDeviceInfo(m_device, CL_DEVICE_IL_VERSION, 0, nullptr,
                         &il_version_size);
  ASSERT_EQ(CL_SUCCESS, iRet) << "clGetDeviceInfo - query CL_DEVICE_IL_VERSION "
                                 "IL version string size failed.";
