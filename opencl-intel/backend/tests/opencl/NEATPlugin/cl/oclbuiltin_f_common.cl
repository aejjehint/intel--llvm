...
__kernel void clamp_s_f(__global float *input, __global int *input_int,
...
__kernel void
step_s_f(__global float *input, __global int *input_int, __global float *output,
...
__kernel void smoothstep_s_f(
    __global float *input, __global int *input_int, __global float *output,
    __global float
...
__kernel void mix_s_f(
    __global float *input, __global int *input_int, __global float *output,
    __global float *output2) // gentypef mix (gentypef x,gentypef y, float a)
{
  IN_VARS_A
  IN_VARS_B
  float c_in = 0.5;
