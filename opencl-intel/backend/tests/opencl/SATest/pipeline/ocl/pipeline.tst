; RUN: SATest -BUILD -enable-expensive-mem-opts=1 -pass-manager-type=ocl -llvm-option=-debug-pass-manager -config=%s.cfg 2>&1 | FileCheck %s
...
; CHECK:      Running pass: SetPreferVectorWidthPass
...
; CHECK-NEXT: Invalidating analysis: LastRunTrackingAnalysis on test
...
; CHECK-NEXT: Running pass: InstCombinePass
; CHECK-NEXT: Running analysis: LastRunTrackingAnalysis on test
; CHECK-NEXT: Running pass: InstSimplifyPass
; CHECK-NEXT: Running pass: LoopSimplifyPass
...
; CHECK-NEXT: Running analysis: LocalBufferAnalysis
; CHECK-NEXT: Running analysis: CallGraphAnalysis
; CHECK:      Running pass: PrivateToHeapPass
