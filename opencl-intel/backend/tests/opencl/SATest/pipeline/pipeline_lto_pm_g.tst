...
; CHECK-NEXT: Running analysis: KernelIndirectCallAnalysis
...
; CHECK:      Running pass: LoopVectorizePass
; CHECK:      Running pass: InstCombinePass
; CHECK:      Running pass: SimplifyCFGPass
; CHECK:      Running pass: PromotePass
...
; CHECK-NEXT: Running pass: InvalidateAnalysisPass<llvm::KernelIndirectCallAnalysis>
...
; CHECK:      Running pass: InvalidateAnalysisPass<llvm::KernelIndirectCallAnalysis>
