...
; The barrier buffer size per WI is ~256KB
; --> total barrier buffer size is larger than 8MB (~256KB * 64)
; CHECK: Set metadata for kernel k: BarrierBufferSize=[[#BUFFER_SIZE_PER_WI:]]
