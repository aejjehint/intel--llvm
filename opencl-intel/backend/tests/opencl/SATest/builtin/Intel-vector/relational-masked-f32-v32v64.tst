...
; CHECK32-NEXT: lshr <32 x i32> [[BITCAST]], splat (i32 31)
; CHECK32: call <32 x float> @_Z9bitselectDv32_fS_S_S_(<32 x float> {{.*}}, <32 x float> {{.*}}, <32 x float> {{.*}}, <32 x float> {{.*}})
; CHECK32: call <32 x float> @_Z14select_v1widenDv32_fS_Dv32_iS_(<32 x float> {{.*}}, <32 x float> {{.*}}, <32 x i32> {{.*}}, <32 x float> {{.*}})
; CHECK32: call <32 x float> @_Z14select_v1widenDv32_fS_Dv32_jS_(<32 x float> {{.*}}, <32 x float> {{.*}}, <32 x i32> {{.*}}, <32 x float> {{.*}})
...
; CHECK64-NEXT: lshr <64 x i32> [[BITCAST]], splat (i32 31)
; CHECK64: call <64 x float> @_Z9bitselectDv64_fS_S_S_(<64 x float> {{.*}}, <64 x float> {{.*}}, <64 x float> {{.*}}, <64 x float> {{.*}})
; CHECK64: call <64 x float> @_Z14select_v1widenDv64_fS_Dv64_iS_(<64 x float> {{.*}}, <64 x float> {{.*}}, <64 x i32> {{.*}}, <64 x float> {{.*}})
; CHECK64: call <64 x float> @_Z14select_v1widenDv64_fS_Dv64_jS_(<64 x float> {{.*}}, <64 x float> {{.*}}, <64 x i32> {{.*}}, <64 x float> {{.*}})
