...
nextafter_half_type(__global half *data1, __global ushort *data2,
  ...
  half from9 = +0.f;
  half to9 = 1.f;
  data10[sglid] = nextafter(from9, to9);

  // -0 to -1
  half from10 = -0.f;
  half to10 = -1.f;
  data11[sglid] = nextafter(from10, to10);
}
