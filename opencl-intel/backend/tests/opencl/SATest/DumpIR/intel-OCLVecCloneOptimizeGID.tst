...
Checks SYCLKernelVecClone assumes global id fits in i32 for OpenCL program, but
not for SYCL program.

CHECK-LABEL: define dso_local void @test
CHECK-OCL-NOT: ashr exact <4 x i64> %{{.*}}, splat (i64 32)
CHECK-SYCL: ashr exact <4 x i64> %{{.*}}, splat (i64 32)
