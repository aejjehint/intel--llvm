...
class LLDJIT : public llvm::ExecutionEngine {
  ...
  public:
    ...
    TmpFile(const llvm::SmallString<256> &FileName);
...
private:
  ...
  public:
    ...
    OwningModuleContainer(OwningModuleContainer &) = delete;
    OwningModuleContainer &operator=(OwningModuleContainer &) = delete;
