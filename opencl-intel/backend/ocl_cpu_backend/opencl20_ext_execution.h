...
__ocl20_get_default_queue(IDeviceCommandManager *);
...
__ocl20_enqueue_marker(queue_t queue, uint32_t num_events_in_wait_list,
                       const clk_event_t *event_wait_list,
                       clk_event_t *event_ret, IDeviceCommandManager *);

/// @brief callback for
///  int retain_event (
///     clk_event_tevent)
extern "C" LLVM_BACKEND_API void __ocl20_retain_event(clk_event_t event,
                                                      IDeviceCommandManager *);

/// @brief callback for
///  int release_event (
///     clk_event_tevent)
extern "C" LLVM_BACKEND_API void __ocl20_release_event(clk_event_t event,
                                                       IDeviceCommandManager *);
...
__ocl20_is_valid_event(clk_event_t, IDeviceCommandManager *);

/// @brief callback for
///  clk_event_tcreate_user_event ()
extern "C" LLVM_BACKEND_API clk_event_t
__ocl20_create_user_event(IDeviceCommandManager *);
