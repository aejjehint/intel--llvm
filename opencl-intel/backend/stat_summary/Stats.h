...
class ModuleStats {
public:
  ModuleStats(const std::string &ver, const std::string &wname,
              const std::string &mname)
      : runtimeVersion(ver), workloadName(wname), moduleName(mname) {}
...
public:
  ...
  ModuleStats &addModule(const std::string &ver, const std::string &wname,
                         const std::string &mname) {
    ModuleStats *MS = new ModuleStats(ver, wname, mname);
