...
macro(use_eh val)
  ...
  if(MSVC) # ICX/MSVC
    if(${val})
      ...
      add_compile_options(/D_HAS_EXCEPTIONS=1)
    else()
...
function(link_target_with_tbb_library target)
  if(WIN32)
    set_property(TARGET ${target} APPEND PROPERTY LINK_OPTIONS
      ...
      "$<$<CONFIG:Release,Debug>:${OCL_OUTPUT_LIBRARY_DIR}/${TBB_LIBNAME_RELEASE}.lib>"
      "$<$<CONFIG:Release,Debug>:LINKER:/DELAYLOAD:${TBB_LIBNAME_RELEASE}.dll>")
  else()
