...
add_compile_definitions(OUTPUT_EMU_SUFF="_${OUTPUT_EMU_SUFF}")
...
macro(set_opencl_version)
  ...
  add_compile_definitions(VERSIONSTRING="${VERSIONSTRING}")
  add_compile_definitions(VERSIONSTRING_WITH_EXT="${VERSIONSTRING}${VERSION_EXT}")
  file(
...
function(add_opencl_library name)
  ...
  if(ARG_SHARED)
    if(WIN32)
      set_property(TARGET ${name} APPEND PROPERTY LINK_OPTIONS
                   $<$<CONFIG:Release>:LINKER:/OPT:REF> $<$<CONFIG:Release>:LINKER:/OPT:ICF>)
    else()
  ...
  if(WIN32 AND ARG_SHARED)
    ...
    set_property(
      TARGET ${name} APPEND PROPERTY LINK_OPTIONS
        $<$<CONFIG:Release>:LINKER:/DEBUG> $<$<CONFIG:Release,Debug>:LINKER:/PDB:${PDB_NAME}>)
