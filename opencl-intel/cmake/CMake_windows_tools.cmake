...
# Linker switches
# IntelLLVM passes linker flags through the driver, therefore they need to be escaped
set(_WL ${CMAKE_CXX_LINKER_WRAPPER_FLAG})
set(ADD_LINKER_FLAGS "${_WL}/INCREMENTAL:NO ${_WL}/DYNAMICBASE ${_WL}/NXCOMPAT ${_WL}/IGNORE:4199")

if(BUILD_X64)
  set(ADD_LINKER_FLAGS "${ADD_LINKER_FLAGS} ${_WL}/MACHINE:X64")
else(BUILD_X64)
  set(ADD_LINKER_FLAGS "${ADD_LINKER_FLAGS} ${_WL}/MACHINE:X86 ${_WL}/SAFESEH")
endif(BUILD_X64)

set(ADD_LINKER_FLAGS_DEBUG "${_WL}/DEBUG ${_WL}/NODEFAULTLIB:LIBCMT ${_WL}/NODEFAULTLIB:LIBCPMT")
set(ADD_LINKER_FLAGS_RELEASE
    "${_WL}/NODEFAULTLIB:LIBCMTD ${_WL}/NODEFAULTLIB:LIBCPMTD ${_WL}/DEPENDENTLOADFLAG:0x2000")
...
set(CMAKE_EXE_LINKER_FLAGS
	"${CMAKE_EXE_LINKER_FLAGS} ${ADD_LINKER_FLAGS}")
...
set(CMAKE_SHARED_LINKER_FLAGS
    "${CMAKE_SHARED_LINKER_FLAGS} ${ADD_LINKER_FLAGS}")
...
string(REPLACE ${_WL}/INCREMENTAL:YES "" CMAKE_EXE_LINKER_FLAGS_DEBUG
               ${CMAKE_EXE_LINKER_FLAGS_DEBUG})
string(REPLACE ${_WL}/INCREMENTAL:YES "" CMAKE_SHARED_LINKER_FLAGS_DEBUG
...
# Intel unified layout requires that all 64-bit dynamic libraries to be
