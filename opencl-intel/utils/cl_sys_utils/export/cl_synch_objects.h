...
public:
  ...
  AtomicPointer &operator=(const AtomicPointer &ac) = default;
...
public:
  OclCondition();
  OclCondition(OclCondition &) = delete;
  OclCondition &operator=(OclCondition &) = delete;
  ~OclCondition();
...
public:
  OclReaderWriterLock();
  OclReaderWriterLock(OclReaderWriterLock &) = delete;
  OclReaderWriterLock &operator=(OclReaderWriterLock &) = delete;
  ~OclReaderWriterLock();
...
public:
  ...
  OclAutoReader(OclAutoReader &) = delete;
  OclAutoReader &operator=(OclAutoReader &) = delete;
...
public:
  ...
  OclAutoWriter(OclAutoWriter &) = delete;
  OclAutoWriter &operator=(OclAutoWriter &) = delete;
  ~OclAutoWriter() {
    assert(m_mutexObj);
