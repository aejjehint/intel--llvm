...
enum E_RETVAL { SUCCESS = 0, FAILURE = 1, OUT_OF_MEMORY = 2 };
...
enum E_EH_TYPE {
  ...
  EH_TYPE_OPENCL_OBJECTS =
      0xff02, // format used to pass LLVM objects / store LLVM binary output
  ...
  EH_TYPE_OPENCL_LINKED_OBJECTS =
      0xff05 // format used to store LLVM IR after link
};
...
enum E_EHT_VERSION { EH_VERSION_INVALID = 0, EH_VERSION_CURRENT = 1 };
...
enum E_EH_FLAGS {
  ...
  EH_FLAG_AVX1 = 2,
  EH_FLAG_AVX2 = 3,
  EH_FLAG_AVX512_SKX = 4,
  EH_FLAG_AVX512_CLX = 5,
