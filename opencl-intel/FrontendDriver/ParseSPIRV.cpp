...
bool ClangFECompilerParseSPIRVTask::isSPIRVSupported(std::string &error) const {
  ...
  for (const auto &capability : m_capabilities) {
    ...
    case spv::internal::CapabilityCooperativeMatrixPrefetchINTEL:
    ...
    case spv::internal::CapabilityCacheControlsINTEL:
    ...
    case spv::CapabilityUntypedPointersKHR:
      ...
      // SPV_EXT_int4
    case spv::internal::CapabilityInt4TypeEXT:
      // SPV_KHR_bfloat16
    case spv::internal::CapabilityBFloat16TypeKHR:
    case spv::internal::CapabilityBFloat16DotProductKHR:
    case spv::internal::CapabilityBFloat16CooperativeMatrixKHR:
      // SPV_INTEL_bfloat8
    case spv::internal::CapabilityFloat8E5M2INTEL:
    case spv::internal::CapabilityFloat8E5M2CooperativeMatrixINTEL:
      // SPV_INTEL_hfloat8
    case spv::internal::CapabilityFloat8E4M3INTEL:
    case spv::internal::CapabilityFloat8E4M3CooperativeMatrixINTEL:
      // SPV_INTEL_fp4
    case spv::internal::CapabilityFloat4E3M0INTEL:
    case spv::internal::CapabilityFloat4E3M0CooperativeMatrixINTEL:
    case spv::internal::CapabilityFloat4E2M1INTEL:
    case spv::internal::CapabilityFloat4E2M1CooperativeMatrixINTEL:
      // SPV_INTEL_fp_conversions
    case spv::internal::CapabilityFloatConversionsINTEL:
