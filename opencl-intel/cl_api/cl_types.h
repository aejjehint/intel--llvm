...
typedef void(CL_CALLBACK *logging_fn)(const char *, const void *, size_t,
                                      void *);
...
#define CL_COMMAND_COMMAND_BUFFER_START 1505
...
enum clk_profiling_info { CLK_PROFILING_COMMAND_EXEC_TIME = 1 };
