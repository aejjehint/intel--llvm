...
class ReadWriteGlobal : public CommandBaseClass<ITask> {
public:
  static cl_dev_err_code Create(TaskDispatcher *pTD, cl_dev_cmd_desc *pCmd,
                                SharedPtr<ITaskBase> *pTask,
                                const SharedPtr<ITaskList> &pList);
...
protected:
  ReadWriteGlobal(TaskDispatcher *pTD, cl_dev_cmd_desc *pCmd);
  cl_dev_err_code CheckCommandParams(cl_dev_cmd_desc *cmd);
};

// OCL read host pipe command
class ReadHostPipe : public CommandBaseClass<ITask> {
public:
  static cl_dev_err_code Create(TaskDispatcher *pTD, cl_dev_cmd_desc *pCmd,
                                SharedPtr<ITaskBase> *pTask,
                                const SharedPtr<ITaskList> &pList);
...
protected:
  ReadHostPipe(TaskDispatcher *pTD, cl_dev_cmd_desc *pCmd);
  cl_dev_err_code CheckCommandParams(cl_dev_cmd_desc *cmd);
};

// OCL write host pipe command
class WriteHostPipe : public CommandBaseClass<ITask> {
public:
  static cl_dev_err_code Create(TaskDispatcher *pTD, cl_dev_cmd_desc *pCmd,
                                SharedPtr<ITaskBase> *pTask,
                                const SharedPtr<ITaskList> &pList);
...
protected:
  WriteHostPipe(TaskDispatcher *pTD, cl_dev_cmd_desc *pCmd);
  cl_dev_err_code CheckCommandParams(cl_dev_cmd_desc *cmd);
};
