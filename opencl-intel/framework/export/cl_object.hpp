...
OCLObject<HandleType, ParentHandleType>::OCLObject(ParentHandleType *parent,
                                                   const std::string &typeName)
    : m_iId(0), m_pParentHandle(parent), m_bTerminate(false),
      m_bPreserveHandleOnDelete(false), m_typename(typeName),
