...
// Sampler C'tor
///////////////////////////////////////////////////////////////////////////////////////////////////
Sampler::Sampler(_cl_context_int *context)
    : OCLObject<_cl_sampler_int>(context, "Sampler") {
  INIT_LOGGER_CLIENT("Sampler", LL_DEBUG);
}
///////////////////////////////////////////////////////////////////////////////////////////////////
// Sampler D'tor
///////////////////////////////////////////////////////////////////////////////////////////////////
Sampler::~Sampler() { LOG_DEBUG(TEXT("%s"), TEXT("Enter Sampler D'tor")); }

cl_err_code Sampler::Initialize(SharedPtr<Context> pContext,
  ...
  m_clSamlerProps |= bNormalizedCoords ? CLK_NORMALIZED_COORDS_TRUE
