...
#define TRACING_SET_ENABLED_BIT(state)                                         \
...
#define TRACING_SET_LOCKED_BIT(state)                                          \
  ((state) | (HostSideTracing::TRACING_STATE_LOCKED_BIT))
#define TRACING_UNSET_LOCKED_BIT(state)                                        \
  ((state) & (~HostSideTracing::TRACING_STATE_LOCKED_BIT))
#define TRACING_GET_LOCKED_BIT(state)                                          \
  ((state) & (HostSideTracing::TRACING_STATE_LOCKED_BIT))

#define TRACING_ZERO_CLIENT_COUNTER(state)                                     \
  ((state) & (HostSideTracing::TRACING_STATE_ENABLED_BIT |                     \
              HostSideTracing::TRACING_STATE_LOCKED_BIT))
#define TRACING_GET_CLIENT_COUNTER(state)                                      \
  ((state) & (~(HostSideTracing::TRACING_STATE_ENABLED_BIT |                   \
                HostSideTracing::TRACING_STATE_LOCKED_BIT)))
...
#define TRACING_ENTER(name, ...)                                               \
  ...
  if (TRACING_GET_ENABLED_BIT(                                                 \
          HostSideTracing::tracingState.load(std::memory_order_acquire))) {    \
...
public:
  ...
  void enter(cl_program *program, cl_uint *numDevices,
             const cl_device_id **deviceList, const char **options,
  ...
  clBuildProgramTracer(clBuildProgramTracer &) = delete;
  clBuildProgramTracer &operator=(clBuildProgramTracer &) = delete;
...
public:
  clSetContextDestructorCallbackTracer() = default;
  ...
  clSetContextDestructorCallbackTracer(clSetContextDestructorCallbackTracer &) =
      delete;
  clSetContextDestructorCallbackTracer &
  operator=(clSetContextDestructorCallbackTracer &) = delete;
...
public:
  ...
  void enter(cl_kernel *sourceKernel, cl_int **errcodeRet) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  ~clCloneKernelTracer() { assert(state != TRACING_NOTIFY_STATE_ENTER_CALLED); }

  clCloneKernelTracer(clCloneKernelTracer &) = delete;
  clCloneKernelTracer &operator=(clCloneKernelTracer &) = delete;
...
public:
  ...
  void enter(cl_program *program, cl_uint *numDevices,
             const cl_device_id **deviceList, const char **options,
             cl_uint *numInputHeaders, const cl_program **inputHeaders,
  ...
  clCompileProgramTracer(clCompileProgramTracer &) = delete;
  clCompileProgramTracer &operator=(clCompileProgramTracer &) = delete;
...
public:
  ...
  void enter(cl_context *context, cl_mem_flags *flags, size_t *size,
             void **hostPtr, cl_int **errcodeRet) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  clCreateBufferTracer(clCreateBufferTracer &) = delete;
  clCreateBufferTracer &operator=(clCreateBufferTracer &) = delete;
...
public:
  ...
  clCreateBufferWithPropertiesTracer(clCreateBufferWithPropertiesTracer &) =
      delete;
  clCreateBufferWithPropertiesTracer &
  operator=(clCreateBufferWithPropertiesTracer &) = delete;
...
public:
  ...
  void enter(cl_context *context, cl_device_id *device,
             cl_command_queue_properties *properties, cl_int **errcodeRet) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  clCreateCommandQueueTracer(clCreateCommandQueueTracer &) = delete;
  clCreateCommandQueueTracer &operator=(clCreateCommandQueueTracer &) = delete;
...
public:
  ...
  void enter(cl_context *context, cl_device_id *device,
             const cl_queue_properties **properties, cl_int **errcodeRet) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  clCreateCommandQueueWithPropertiesTracer(
      clCreateCommandQueueWithPropertiesTracer &) = delete;
  clCreateCommandQueueWithPropertiesTracer &
  operator=(clCreateCommandQueueWithPropertiesTracer &) = delete;
...
public:
  ...
  void enter(const cl_context_properties **properties, cl_uint *numDevices,
  ...
  clCreateContextTracer(clCreateContextTracer &) = delete;
  clCreateContextTracer &operator=(clCreateContextTracer &) = delete;
...
public:
  ...
  clCreateContextFromTypeTracer(clCreateContextFromTypeTracer &) = delete;
  clCreateContextFromTypeTracer &
  operator=(clCreateContextFromTypeTracer &) = delete;
...
public:
  ...
  void enter(cl_context *context, cl_mem_flags *flags,
  ...
  ~clCreateImageTracer() { assert(state != TRACING_NOTIFY_STATE_ENTER_CALLED); }

  clCreateImageTracer(clCreateImageTracer &) = delete;
  clCreateImageTracer &operator=(clCreateImageTracer &) = delete;
...
public:
  ...
  clCreateImageWithPropertiesTracer(clCreateImageWithPropertiesTracer &) =
      delete;
  clCreateImageWithPropertiesTracer &
  operator=(clCreateImageWithPropertiesTracer &) = delete;
...
public:
  ...
  void enter(cl_context *context, cl_mem_flags *flags,
             const cl_image_format **imageFormat, size_t *imageWidth,
             size_t *imageHeight, size_t *imageRowPitch, void **hostPtr,
             cl_int **errcodeRet) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  clCreateImage2DTracer(clCreateImage2DTracer &) = delete;
  clCreateImage2DTracer &operator=(clCreateImage2DTracer &) = delete;
...
public:
  ...
  void enter(cl_context *context, cl_mem_flags *flags,
             const cl_image_format **imageFormat, size_t *imageWidth,
             size_t *imageHeight, size_t *imageDepth, size_t *imageRowPitch,
             size_t *imageSlicePitch, void **hostPtr, cl_int **errcodeRet) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  clCreateImage3DTracer(clCreateImage3DTracer &) = delete;
  clCreateImage3DTracer &operator=(clCreateImage3DTracer &) = delete;
...
public:
  ...
  void enter(cl_program *program, const char **kernelName,
             cl_int **errcodeRet) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  clCreateKernelTracer(clCreateKernelTracer &) = delete;
  clCreateKernelTracer &operator=(clCreateKernelTracer &) = delete;
...
public:
  ...
  void enter(cl_program *program, cl_uint *numKernels, cl_kernel **kernels,
  ...
  clCreateKernelsInProgramTracer(clCreateKernelsInProgramTracer &) = delete;
  clCreateKernelsInProgramTracer &
  operator=(clCreateKernelsInProgramTracer &) = delete;
...
public:
  ...
  void enter(cl_context *context, cl_mem_flags *flags, cl_uint *pipePacketSize,
             cl_uint *pipeMaxPackets, const cl_pipe_properties **properties,
             cl_int **errcodeRet) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  ~clCreatePipeTracer() { assert(state != TRACING_NOTIFY_STATE_ENTER_CALLED); }

  clCreatePipeTracer(clCreatePipeTracer &) = delete;
  clCreatePipeTracer &operator=(clCreatePipeTracer &) = delete;
...
public:
  ...
  void enter(cl_context *context, cl_uint *numDevices,
             const cl_device_id **deviceList, const size_t **lengths,
             const unsigned char ***binaries, cl_int **binaryStatus,
             cl_int **errcodeRet) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  clCreateProgramWithBinaryTracer(clCreateProgramWithBinaryTracer &) = delete;
  clCreateProgramWithBinaryTracer &
  operator=(clCreateProgramWithBinaryTracer &) = delete;
...
public:
  ...
  void enter(cl_context *context, cl_uint *numDevices,
             const cl_device_id **deviceList, const char **kernelNames,
             cl_int **errcodeRet) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
    ...
    for (size_t i = 0; i < tracingHandle.size(); ++i) {
      ...
      assert(handle != nullptr);
      if (handle->getTracingPoint(
              CL_FUNCTION_clCreateProgramWithBuiltInKernels)) {
        data.correlationData = correlationData + i;
  ...
  clCreateProgramWithBuiltInKernelsTracer(
      clCreateProgramWithBuiltInKernelsTracer &) = delete;
  clCreateProgramWithBuiltInKernelsTracer &
  operator=(clCreateProgramWithBuiltInKernelsTracer &) = delete;
...
public:
  ...
  void enter(cl_context *context, const void **il, size_t *length,
             cl_int **errcodeRet) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  clCreateProgramWithILTracer(clCreateProgramWithILTracer &) = delete;
  clCreateProgramWithILTracer &
  operator=(clCreateProgramWithILTracer &) = delete;
...
public:
  ...
  void enter(cl_context *context, cl_uint *count, const char ***strings,
             const size_t **lengths, cl_int **errcodeRet) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  clCreateProgramWithSourceTracer(clCreateProgramWithSourceTracer &) = delete;
  clCreateProgramWithSourceTracer &
  operator=(clCreateProgramWithSourceTracer &) = delete;
...
public:
  ...
  void enter(cl_context *context, cl_bool *normalizedCoords,
  ...
  clCreateSamplerTracer(clCreateSamplerTracer &) = delete;
  clCreateSamplerTracer &operator=(clCreateSamplerTracer &) = delete;
...
public:
  ...
  clCreateSamplerWithPropertiesTracer(clCreateSamplerWithPropertiesTracer &) =
      delete;
  clCreateSamplerWithPropertiesTracer &
  operator=(clCreateSamplerWithPropertiesTracer &) = delete;
...
public:
  ...
  void enter(cl_mem *buffer, cl_mem_flags *flags,
             cl_buffer_create_type *bufferCreateType,
             const void **bufferCreateInfo, cl_int **errcodeRet) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  clCreateSubBufferTracer(clCreateSubBufferTracer &) = delete;
  clCreateSubBufferTracer &operator=(clCreateSubBufferTracer &) = delete;
...
public:
  ...
  void enter(cl_device_id *inDevice,
             ...
             cl_uint *numDevices, cl_device_id **outDevices,
  ...
  clCreateSubDevicesTracer(clCreateSubDevicesTracer &) = delete;
  clCreateSubDevicesTracer &operator=(clCreateSubDevicesTracer &) = delete;
...
public:
  ...
  void enter(cl_context *context, cl_int **errcodeRet) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  clCreateUserEventTracer(clCreateUserEventTracer &) = delete;
  clCreateUserEventTracer &operator=(clCreateUserEventTracer &) = delete;
...
public:
  ...
  clEnqueueBarrierTracer(clEnqueueBarrierTracer &) = delete;
  clEnqueueBarrierTracer &operator=(clEnqueueBarrierTracer &) = delete;
...
public:
  ...
  void enter(cl_command_queue *commandQueue, cl_uint *numEventsInWaitList,
  ...
  clEnqueueBarrierWithWaitListTracer(clEnqueueBarrierWithWaitListTracer &) =
      delete;
  clEnqueueBarrierWithWaitListTracer &
  operator=(clEnqueueBarrierWithWaitListTracer &) = delete;
...
public:
  ...
  void enter(cl_command_queue *commandQueue, cl_mem *srcBuffer,
             cl_mem *dstBuffer, size_t *srcOffset, size_t *dstOffset,
             size_t *cb, cl_uint *numEventsInWaitList,
             const cl_event **eventWaitList, cl_event **event) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  clEnqueueCopyBufferTracer(clEnqueueCopyBufferTracer &) = delete;
  clEnqueueCopyBufferTracer &operator=(clEnqueueCopyBufferTracer &) = delete;
...
public:
  ...
  void enter(cl_command_queue *commandQueue, cl_mem *srcBuffer,
             cl_mem *dstBuffer, const size_t **srcOrigin,
  ...
  clEnqueueCopyBufferRectTracer(clEnqueueCopyBufferRectTracer &) = delete;
  clEnqueueCopyBufferRectTracer &
  operator=(clEnqueueCopyBufferRectTracer &) = delete;
...
public:
  ...
  void enter(cl_command_queue *commandQueue, cl_mem *srcBuffer,
             cl_mem *dstImage, size_t *srcOffset, const size_t **dstOrigin,
             const size_t **region, cl_uint *numEventsInWaitList,
             const cl_event **eventWaitList, cl_event **event) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  clEnqueueCopyBufferToImageTracer(clEnqueueCopyBufferToImageTracer &) = delete;
  clEnqueueCopyBufferToImageTracer &
  operator=(clEnqueueCopyBufferToImageTracer &) = delete;
...
public:
  ...
  void enter(cl_command_queue *commandQueue, cl_mem *srcImage, cl_mem *dstImage,
  ...
  clEnqueueCopyImageTracer(clEnqueueCopyImageTracer &) = delete;
  clEnqueueCopyImageTracer &operator=(clEnqueueCopyImageTracer &) = delete;
...
public:
  ...
  void enter(cl_command_queue *commandQueue, cl_mem *srcImage,
             cl_mem *dstBuffer, const size_t **srcOrigin, const size_t **region,
  ...
  clEnqueueCopyImageToBufferTracer(clEnqueueCopyImageToBufferTracer &) = delete;
  clEnqueueCopyImageToBufferTracer &
  operator=(clEnqueueCopyImageToBufferTracer &) = delete;
...
public:
  ...
  void enter(cl_command_queue *commandQueue, cl_mem *buffer,
             const void **pattern, size_t *patternSize, size_t *offset,
  ...
  clEnqueueFillBufferTracer(clEnqueueFillBufferTracer &) = delete;
  clEnqueueFillBufferTracer &operator=(clEnqueueFillBufferTracer &) = delete;
...
public:
  ...
  void enter(cl_command_queue *commandQueue, cl_mem *image,
  ...
  clEnqueueFillImageTracer(clEnqueueFillImageTracer &) = delete;
  clEnqueueFillImageTracer &operator=(clEnqueueFillImageTracer &) = delete;
...
public:
  ...
  void enter(cl_command_queue *commandQueue, cl_mem *buffer,
             cl_bool *blockingMap, cl_map_flags *mapFlags, size_t *offset,
             size_t *cb, cl_uint *numEventsInWaitList,
             const cl_event **eventWaitList, cl_event **event,
             cl_int **errcodeRet) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  clEnqueueMapBufferTracer(clEnqueueMapBufferTracer &) = delete;
  clEnqueueMapBufferTracer &operator=(clEnqueueMapBufferTracer &) = delete;
...
public:
  ...
  void enter(cl_command_queue *commandQueue, cl_mem *image,
             cl_bool *blockingMap, cl_map_flags *mapFlags,
             const size_t **origin, const size_t **region,
             size_t **imageRowPitch, size_t **imageSlicePitch,
             cl_uint *numEventsInWaitList, const cl_event **eventWaitList,
             cl_event **event, cl_int **errcodeRet) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  clEnqueueMapImageTracer(clEnqueueMapImageTracer &) = delete;
  clEnqueueMapImageTracer &operator=(clEnqueueMapImageTracer &) = delete;
...
public:
  ...
  void enter(cl_command_queue *commandQueue, cl_event **event) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  clEnqueueMarkerTracer(clEnqueueMarkerTracer &) = delete;
  clEnqueueMarkerTracer &operator=(clEnqueueMarkerTracer &) = delete;
...
public:
  ...
  clEnqueueMarkerWithWaitListTracer(clEnqueueMarkerWithWaitListTracer &) =
      delete;
  clEnqueueMarkerWithWaitListTracer &
  operator=(clEnqueueMarkerWithWaitListTracer &) = delete;
...
public:
  ...
  void enter(cl_command_queue *commandQueue, cl_uint *numMemObjects,
             const cl_mem **memObjects, cl_mem_migration_flags *flags,
             cl_uint *numEventsInWaitList, const cl_event **eventWaitList,
             cl_event **event) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  clEnqueueMigrateMemObjectsTracer(clEnqueueMigrateMemObjectsTracer &) = delete;
  clEnqueueMigrateMemObjectsTracer &
  operator=(clEnqueueMigrateMemObjectsTracer &) = delete;
...
public:
  ...
  void enter(cl_command_queue *commandQueue, cl_kernel *kernel,
  ...
  clEnqueueNDRangeKernelTracer(clEnqueueNDRangeKernelTracer &) = delete;
  clEnqueueNDRangeKernelTracer &
  operator=(clEnqueueNDRangeKernelTracer &) = delete;
...
public:
  ...
  void enter(cl_command_queue *commandQueue,
             void(CL_CALLBACK **userFunc)(void *), void **args, size_t *cbArgs,
             cl_uint *numMemObjects, const cl_mem **memList,
             const void ***argsMemLoc, cl_uint *numEventsInWaitList,
             const cl_event **eventWaitList, cl_event **event) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  clEnqueueNativeKernelTracer(clEnqueueNativeKernelTracer &) = delete;
  clEnqueueNativeKernelTracer &
  operator=(clEnqueueNativeKernelTracer &) = delete;
...
public:
  ...
  clEnqueueReadBufferTracer(clEnqueueReadBufferTracer &) = delete;
  clEnqueueReadBufferTracer &operator=(clEnqueueReadBufferTracer &) = delete;
...
public:
  ...
  void enter(cl_command_queue *commandQueue, cl_mem *buffer,
             cl_bool *blockingRead, const size_t **bufferOrigin,
             const size_t **hostOrigin, const size_t **region,
  ...
  clEnqueueReadBufferRectTracer(clEnqueueReadBufferRectTracer &) = delete;
  clEnqueueReadBufferRectTracer &
  operator=(clEnqueueReadBufferRectTracer &) = delete;
...
public:
  ...
  void enter(cl_command_queue *commandQueue, cl_mem *image,
             cl_bool *blockingRead, const size_t **origin,
  ...
  clEnqueueReadImageTracer(clEnqueueReadImageTracer &) = delete;
  clEnqueueReadImageTracer &operator=(clEnqueueReadImageTracer &) = delete;
...
public:
  ...
  void enter(cl_command_queue *commandQueue, cl_uint *numSvmPointers,
             void ***svmPointers,
             void(CL_CALLBACK **pfnFreeFunc)(cl_command_queue queue,
                                             cl_uint numSvmPointers,
                                             void **svmPointers,
                                             void *userData),
             void **userData, cl_uint *numEventsInWaitList,
             const cl_event **eventWaitList, cl_event **event) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  clEnqueueSVMFreeTracer(clEnqueueSVMFreeTracer &) = delete;
  clEnqueueSVMFreeTracer &operator=(clEnqueueSVMFreeTracer &) = delete;
...
public:
  ...
  void enter(cl_command_queue *commandQueue, cl_bool *blockingMap,
             cl_map_flags *mapFlags, void **svmPtr, size_t *size,
             cl_uint *numEventsInWaitList, const cl_event **eventWaitList,
             cl_event **event) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  clEnqueueSVMMapTracer(clEnqueueSVMMapTracer &) = delete;
  clEnqueueSVMMapTracer &operator=(clEnqueueSVMMapTracer &) = delete;
...
public:
  ...
  void enter(cl_command_queue *commandQueue, void **svmPtr,
  ...
  clEnqueueSVMMemFillTracer(clEnqueueSVMMemFillTracer &) = delete;
  clEnqueueSVMMemFillTracer &operator=(clEnqueueSVMMemFillTracer &) = delete;
...
public:
  ...
  void enter(cl_command_queue *commandQueue, cl_bool *blockingCopy,
  ...
  clEnqueueSVMMemcpyTracer(clEnqueueSVMMemcpyTracer &) = delete;
  clEnqueueSVMMemcpyTracer &operator=(clEnqueueSVMMemcpyTracer &) = delete;
...
public:
  ...
  void enter(cl_command_queue *commandQueue, cl_uint *numSvmPointers,
             const void ***svmPointers, const size_t **sizes,
  ...
  clEnqueueSVMMigrateMemTracer(clEnqueueSVMMigrateMemTracer &) = delete;
  clEnqueueSVMMigrateMemTracer &
  operator=(clEnqueueSVMMigrateMemTracer &) = delete;
...
public:
  ...
  clEnqueueSVMUnmapTracer(clEnqueueSVMUnmapTracer &) = delete;
  clEnqueueSVMUnmapTracer &operator=(clEnqueueSVMUnmapTracer &) = delete;
...
public:
  ...
  ~clEnqueueTaskTracer() { assert(state != TRACING_NOTIFY_STATE_ENTER_CALLED); }

  clEnqueueTaskTracer(clEnqueueTaskTracer &) = delete;
  clEnqueueTaskTracer &operator=(clEnqueueTaskTracer &) = delete;
...
public:
  ...
  void enter(cl_command_queue *commandQueue, cl_mem *memobj, void **mappedPtr,
             cl_uint *numEventsInWaitList, const cl_event **eventWaitList,
             cl_event **event) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  clEnqueueUnmapMemObjectTracer(clEnqueueUnmapMemObjectTracer &) = delete;
  clEnqueueUnmapMemObjectTracer &
  operator=(clEnqueueUnmapMemObjectTracer &) = delete;
...
public:
  ...
  void enter(cl_command_queue *commandQueue, cl_uint *numEvents,
  ...
  clEnqueueWaitForEventsTracer(clEnqueueWaitForEventsTracer &) = delete;
  clEnqueueWaitForEventsTracer &
  operator=(clEnqueueWaitForEventsTracer &) = delete;
...
public:
  ...
  void enter(cl_command_queue *commandQueue, cl_mem *buffer,
             cl_bool *blockingWrite, size_t *offset, size_t *cb,
  ...
  clEnqueueWriteBufferTracer(clEnqueueWriteBufferTracer &) = delete;
  clEnqueueWriteBufferTracer &operator=(clEnqueueWriteBufferTracer &) = delete;
...
public:
  ...
  void enter(cl_command_queue *commandQueue, cl_mem *buffer,
             cl_bool *blockingWrite, const size_t **bufferOrigin,
             const size_t **hostOrigin, const size_t **region,
             size_t *bufferRowPitch, size_t *bufferSlicePitch,
  ...
  clEnqueueWriteBufferRectTracer(clEnqueueWriteBufferRectTracer &) = delete;
  clEnqueueWriteBufferRectTracer &
  operator=(clEnqueueWriteBufferRectTracer &) = delete;
...
public:
  ...
  void enter(cl_command_queue *commandQueue, cl_mem *image,
             cl_bool *blockingWrite, const size_t **origin,
  ...
  clEnqueueWriteImageTracer(clEnqueueWriteImageTracer &) = delete;
  clEnqueueWriteImageTracer &operator=(clEnqueueWriteImageTracer &) = delete;
...
public:
  ...
  ~clFinishTracer() { assert(state != TRACING_NOTIFY_STATE_ENTER_CALLED); }

  clFinishTracer(clFinishTracer &) = delete;
  clFinishTracer &operator=(clFinishTracer &) = delete;
...
public:
  ...
  ~clFlushTracer() { assert(state != TRACING_NOTIFY_STATE_ENTER_CALLED); }

  clFlushTracer(clFlushTracer &) = delete;
  clFlushTracer &operator=(clFlushTracer &) = delete;
...
public:
  ...
  void enter(cl_command_queue *commandQueue, cl_command_queue_info *paramName,
  ...
  clGetCommandQueueInfoTracer(clGetCommandQueueInfoTracer &) = delete;
  clGetCommandQueueInfoTracer &
  operator=(clGetCommandQueueInfoTracer &) = delete;
...
public:
  ...
  void enter(cl_context *context, cl_context_info *paramName,
             size_t *paramValueSize, void **paramValue,
             size_t **paramValueSizeRet) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  clGetContextInfoTracer(clGetContextInfoTracer &) = delete;
  clGetContextInfoTracer &operator=(clGetContextInfoTracer &) = delete;
...
public:
  ...
  void enter(cl_device_id *device, cl_ulong **deviceTimestamp,
  ...
  clGetDeviceAndHostTimerTracer(clGetDeviceAndHostTimerTracer &) = delete;
  clGetDeviceAndHostTimerTracer &
  operator=(clGetDeviceAndHostTimerTracer &) = delete;
...
public:
  ...
  void enter(cl_platform_id *platform, cl_device_type *deviceType,
  ...
  clGetDeviceIDsTracer(clGetDeviceIDsTracer &) = delete;
  clGetDeviceIDsTracer &operator=(clGetDeviceIDsTracer &) = delete;
...
public:
  ...
  void enter(cl_device_id *device, cl_device_info *paramName,
             size_t *paramValueSize, void **paramValue,
             size_t **paramValueSizeRet) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  clGetDeviceInfoTracer(clGetDeviceInfoTracer &) = delete;
  clGetDeviceInfoTracer &operator=(clGetDeviceInfoTracer &) = delete;
...
public:
  ...
  void enter(cl_event *event, cl_event_info *paramName, size_t *paramValueSize,
  ...
  clGetEventInfoTracer(clGetEventInfoTracer &) = delete;
  clGetEventInfoTracer &operator=(clGetEventInfoTracer &) = delete;
...
public:
  ...
  void enter(cl_event *event, cl_profiling_info *paramName,
             size_t *paramValueSize, void **paramValue,
             size_t **paramValueSizeRet) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  clGetEventProfilingInfoTracer(clGetEventProfilingInfoTracer &) = delete;
  clGetEventProfilingInfoTracer &
  operator=(clGetEventProfilingInfoTracer &) = delete;
...
public:
  ...
  clGetExtensionFunctionAddressTracer(clGetExtensionFunctionAddressTracer &) =
      delete;
  clGetExtensionFunctionAddressTracer &
  operator=(clGetExtensionFunctionAddressTracer &) = delete;
...
public:
  ...
  void enter(cl_platform_id *platform, const char **funcName) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
    ...
    for (size_t i = 0; i < tracingHandle.size(); ++i) {
      ...
      if (handle->getTracingPoint(
        ...
        data.correlationData = correlationData + i;
        handle->call(CL_FUNCTION_clGetExtensionFunctionAddressForPlatform,
                     &data);
      }
    }
  ...
  clGetExtensionFunctionAddressForPlatformTracer(
      clGetExtensionFunctionAddressForPlatformTracer &) = delete;
  clGetExtensionFunctionAddressForPlatformTracer &
  operator=(clGetExtensionFunctionAddressForPlatformTracer &) = delete;
...
public:
  ...
  void enter(cl_device_id *device, cl_ulong **hostTimestamp) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  clGetHostTimerTracer(clGetHostTimerTracer &) = delete;
  clGetHostTimerTracer &operator=(clGetHostTimerTracer &) = delete;
...
public:
  ...
  void enter(cl_mem *image, cl_image_info *paramName, size_t *paramValueSize,
             void **paramValue, size_t **paramValueSizeRet) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  clGetImageInfoTracer(clGetImageInfoTracer &) = delete;
  clGetImageInfoTracer &operator=(clGetImageInfoTracer &) = delete;
...
public:
  ...
  void enter(cl_kernel *kernel, cl_uint *argIndx, cl_kernel_arg_info *paramName,
             size_t *paramValueSize, void **paramValue,
             size_t **paramValueSizeRet) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  clGetKernelArgInfoTracer(clGetKernelArgInfoTracer &) = delete;
  clGetKernelArgInfoTracer &operator=(clGetKernelArgInfoTracer &) = delete;
...
public:
  ...
  void enter(cl_kernel *kernel, cl_kernel_info *paramName,
             size_t *paramValueSize, void **paramValue,
             size_t **paramValueSizeRet) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  clGetKernelInfoTracer(clGetKernelInfoTracer &) = delete;
  clGetKernelInfoTracer &operator=(clGetKernelInfoTracer &) = delete;
...
public:
  ...
  void enter(cl_kernel *kernel, cl_device_id *device,
             cl_kernel_sub_group_info *paramName, size_t *inputValueSize,
             const void **inputValue, size_t *paramValueSize, void **paramValue,
             size_t **paramValueSizeRet) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  clGetKernelSubGroupInfoTracer(clGetKernelSubGroupInfoTracer &) = delete;
  clGetKernelSubGroupInfoTracer &
  operator=(clGetKernelSubGroupInfoTracer &) = delete;
...
public:
  ...
  void enter(cl_kernel *kernel, cl_device_id *device,
             cl_kernel_work_group_info *paramName, size_t *paramValueSize,
             void **paramValue, size_t **paramValueSizeRet) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  clGetKernelWorkGroupInfoTracer(clGetKernelWorkGroupInfoTracer &) = delete;
  clGetKernelWorkGroupInfoTracer &
  operator=(clGetKernelWorkGroupInfoTracer &) = delete;
...
public:
  ...
  void enter(cl_mem *memobj, cl_mem_info *paramName, size_t *paramValueSize,
             void **paramValue, size_t **paramValueSizeRet) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  clGetMemObjectInfoTracer(clGetMemObjectInfoTracer &) = delete;
  clGetMemObjectInfoTracer &operator=(clGetMemObjectInfoTracer &) = delete;
...
public:
  ...
  void enter(cl_mem *pipe, cl_pipe_info *paramName, size_t *paramValueSize,
             void **paramValue, size_t **paramValueSizeRet) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  ~clGetPipeInfoTracer() { assert(state != TRACING_NOTIFY_STATE_ENTER_CALLED); }

  clGetPipeInfoTracer(clGetPipeInfoTracer &) = delete;
  clGetPipeInfoTracer &operator=(clGetPipeInfoTracer &) = delete;
...
public:
  ...
  void enter(cl_uint *numEntries, cl_platform_id **platforms,
  ...
  clGetPlatformIDsTracer(clGetPlatformIDsTracer &) = delete;
  clGetPlatformIDsTracer &operator=(clGetPlatformIDsTracer &) = delete;
...
public:
  ...
  void enter(cl_platform_id *platform, cl_platform_info *paramName,
             size_t *paramValueSize, void **paramValue,
             size_t **paramValueSizeRet) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  clGetPlatformInfoTracer(clGetPlatformInfoTracer &) = delete;
  clGetPlatformInfoTracer &operator=(clGetPlatformInfoTracer &) = delete;
...
public:
  ...
  void enter(cl_program *program, cl_device_id *device,
             cl_program_build_info *paramName, size_t *paramValueSize,
             void **paramValue, size_t **paramValueSizeRet) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  clGetProgramBuildInfoTracer(clGetProgramBuildInfoTracer &) = delete;
  clGetProgramBuildInfoTracer &
  operator=(clGetProgramBuildInfoTracer &) = delete;
...
public:
  ...
  void enter(cl_program *program, cl_program_info *paramName,
             size_t *paramValueSize, void **paramValue,
             size_t **paramValueSizeRet) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  clGetProgramInfoTracer(clGetProgramInfoTracer &) = delete;
  clGetProgramInfoTracer &operator=(clGetProgramInfoTracer &) = delete;
...
public:
  ...
  void enter(cl_sampler *sampler, cl_sampler_info *paramName,
             size_t *paramValueSize, void **paramValue,
             size_t **paramValueSizeRet) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  clGetSamplerInfoTracer(clGetSamplerInfoTracer &) = delete;
  clGetSamplerInfoTracer &operator=(clGetSamplerInfoTracer &) = delete;
...
public:
  ...
  clGetSupportedImageFormatsTracer(clGetSupportedImageFormatsTracer &) = delete;
  clGetSupportedImageFormatsTracer &
  operator=(clGetSupportedImageFormatsTracer &) = delete;
...
public:
  ...
  ~clLinkProgramTracer() { assert(state != TRACING_NOTIFY_STATE_ENTER_CALLED); }

  clLinkProgramTracer(clLinkProgramTracer &) = delete;
  clLinkProgramTracer &operator=(clLinkProgramTracer &) = delete;
...
public:
  ...
  clReleaseCommandQueueTracer(clReleaseCommandQueueTracer &) = delete;
  clReleaseCommandQueueTracer &
  operator=(clReleaseCommandQueueTracer &) = delete;
...
public:
  ...
  clReleaseContextTracer(clReleaseContextTracer &) = delete;
  clReleaseContextTracer &operator=(clReleaseContextTracer &) = delete;
...
public:
  ...
  clReleaseDeviceTracer(clReleaseDeviceTracer &) = delete;
  clReleaseDeviceTracer &operator=(clReleaseDeviceTracer &) = delete;
...
public:
  ...
  clReleaseEventTracer(clReleaseEventTracer &) = delete;
  clReleaseEventTracer &operator=(clReleaseEventTracer &) = delete;
...
public:
  ...
  clReleaseKernelTracer(clReleaseKernelTracer &) = delete;
  clReleaseKernelTracer &operator=(clReleaseKernelTracer &) = delete;
...
public:
  ...
  clReleaseMemObjectTracer(clReleaseMemObjectTracer &) = delete;
  clReleaseMemObjectTracer &operator=(clReleaseMemObjectTracer &) = delete;
...
public:
  ...
  clReleaseProgramTracer(clReleaseProgramTracer &) = delete;
  clReleaseProgramTracer &operator=(clReleaseProgramTracer &) = delete;
...
public:
  ...
  clReleaseSamplerTracer(clReleaseSamplerTracer &) = delete;
  clReleaseSamplerTracer &operator=(clReleaseSamplerTracer &) = delete;
...
public:
  ...
  clRetainCommandQueueTracer(clRetainCommandQueueTracer &) = delete;
  clRetainCommandQueueTracer &operator=(clRetainCommandQueueTracer &) = delete;
...
public:
  ...
  clRetainContextTracer(clRetainContextTracer &) = delete;
  clRetainContextTracer &operator=(clRetainContextTracer &) = delete;
...
public:
  ...
  clRetainDeviceTracer(clRetainDeviceTracer &) = delete;
  clRetainDeviceTracer &operator=(clRetainDeviceTracer &) = delete;
...
public:
  ...
  ~clRetainEventTracer() { assert(state != TRACING_NOTIFY_STATE_ENTER_CALLED); }

  clRetainEventTracer(clRetainEventTracer &) = delete;
  clRetainEventTracer &operator=(clRetainEventTracer &) = delete;
...
public:
  ...
  clRetainKernelTracer(clRetainKernelTracer &) = delete;
  clRetainKernelTracer &operator=(clRetainKernelTracer &) = delete;
...
public:
  ...
  clRetainMemObjectTracer(clRetainMemObjectTracer &) = delete;
  clRetainMemObjectTracer &operator=(clRetainMemObjectTracer &) = delete;
...
public:
  ...
  clRetainProgramTracer(clRetainProgramTracer &) = delete;
  clRetainProgramTracer &operator=(clRetainProgramTracer &) = delete;
...
public:
  ...
  clRetainSamplerTracer(clRetainSamplerTracer &) = delete;
  clRetainSamplerTracer &operator=(clRetainSamplerTracer &) = delete;
...
public:
  ...
  void enter(cl_context *context, cl_svm_mem_flags *flags, size_t *size,
             cl_uint *alignment) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  ~clSVMAllocTracer() { assert(state != TRACING_NOTIFY_STATE_ENTER_CALLED); }

  clSVMAllocTracer(clSVMAllocTracer &) = delete;
  clSVMAllocTracer &operator=(clSVMAllocTracer &) = delete;
...
public:
  ...
  void enter(cl_context *context, void **svmPointer) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  ~clSVMFreeTracer() { assert(state != TRACING_NOTIFY_STATE_ENTER_CALLED); }

  clSVMFreeTracer(clSVMFreeTracer &) = delete;
  clSVMFreeTracer &operator=(clSVMFreeTracer &) = delete;
...
public:
  ...
  clSetCommandQueuePropertyTracer(clSetCommandQueuePropertyTracer &) = delete;
  clSetCommandQueuePropertyTracer &
  operator=(clSetCommandQueuePropertyTracer &) = delete;
...
public:
  ...
  clSetDefaultDeviceCommandQueueTracer(clSetDefaultDeviceCommandQueueTracer &) =
      delete;
  clSetDefaultDeviceCommandQueueTracer &
  operator=(clSetDefaultDeviceCommandQueueTracer &) = delete;
...
public:
  ...
  void enter(cl_event *event, cl_int *commandExecCallbackType,
  ...
  clSetEventCallbackTracer(clSetEventCallbackTracer &) = delete;
  clSetEventCallbackTracer &operator=(clSetEventCallbackTracer &) = delete;
...
public:
  ...
  void enter(cl_kernel *kernel, cl_uint *argIndex, size_t *argSize,
             const void **argValue) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  clSetKernelArgTracer(clSetKernelArgTracer &) = delete;
  clSetKernelArgTracer &operator=(clSetKernelArgTracer &) = delete;
...
public:
  ...
  void enter(cl_kernel *kernel, cl_uint *argIndex, const void **argValue) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  clSetKernelArgSVMPointerTracer(clSetKernelArgSVMPointerTracer &) = delete;
  clSetKernelArgSVMPointerTracer &
  operator=(clSetKernelArgSVMPointerTracer &) = delete;
...
public:
  ...
  void enter(cl_kernel *kernel, cl_kernel_exec_info *paramName,
  ...
  clSetKernelExecInfoTracer(clSetKernelExecInfoTracer &) = delete;
  clSetKernelExecInfoTracer &operator=(clSetKernelExecInfoTracer &) = delete;
...
public:
  ...
  void enter(cl_mem *memobj, void(CL_CALLBACK **funcNotify)(cl_mem, void *),
             void **userData) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
    ...
    for (size_t i = 0; i < tracingHandle.size(); ++i) {
      ...
      assert(handle != nullptr);
      if (handle->getTracingPoint(
              CL_FUNCTION_clSetMemObjectDestructorCallback)) {
        data.correlationData = correlationData + i;
  ...
  clSetMemObjectDestructorCallbackTracer(
      clSetMemObjectDestructorCallbackTracer &) = delete;
  clSetMemObjectDestructorCallbackTracer &
  operator=(clSetMemObjectDestructorCallbackTracer &) = delete;
...
public:
  ...
  void enter(cl_event *event, cl_int *executionStatus) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  clSetUserEventStatusTracer(clSetUserEventStatusTracer &) = delete;
  clSetUserEventStatusTracer &operator=(clSetUserEventStatusTracer &) = delete;
...
public:
  ...
  clUnloadCompilerTracer(clUnloadCompilerTracer &) = delete;
  clUnloadCompilerTracer &operator=(clUnloadCompilerTracer &) = delete;
...
public:
  ...
  clUnloadPlatformCompilerTracer(clUnloadPlatformCompilerTracer &) = delete;
  clUnloadPlatformCompilerTracer &
  operator=(clUnloadPlatformCompilerTracer &) = delete;
...
public:
  ...
  void enter(cl_uint *numEvents, const cl_event **eventList) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  clWaitForEventsTracer(clWaitForEventsTracer &) = delete;
  clWaitForEventsTracer &operator=(clWaitForEventsTracer &) = delete;
...
public:
  ...
  void enter(cl_context *context, cl_mem_flags *flags, cl_GLuint *bufobj,
             int **errcodeRet) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  clCreateFromGLBufferTracer(clCreateFromGLBufferTracer &) = delete;
  clCreateFromGLBufferTracer &operator=(clCreateFromGLBufferTracer &) = delete;
...
public:
  ...
  void enter(cl_context *context, cl_mem_flags *flags, cl_GLuint *renderbuffer,
             cl_int **errcodeRet) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  clCreateFromGLRenderbufferTracer(clCreateFromGLRenderbufferTracer &) = delete;
  clCreateFromGLRenderbufferTracer &
  operator=(clCreateFromGLRenderbufferTracer &) = delete;
...
public:
  ...
  void enter(cl_context *context, cl_mem_flags *flags, cl_GLenum *target,
             cl_GLint *miplevel, cl_GLuint *texture, cl_int **errcodeRet) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  clCreateFromGLTextureTracer(clCreateFromGLTextureTracer &) = delete;
  clCreateFromGLTextureTracer &
  operator=(clCreateFromGLTextureTracer &) = delete;
...
public:
  ...
  clCreateFromGLTexture2DTracer(clCreateFromGLTexture2DTracer &) = delete;
  clCreateFromGLTexture2DTracer &
  operator=(clCreateFromGLTexture2DTracer &) = delete;
...
public:
  ...
  clCreateFromGLTexture3DTracer(clCreateFromGLTexture3DTracer &) = delete;
  clCreateFromGLTexture3DTracer &
  operator=(clCreateFromGLTexture3DTracer &) = delete;
...
public:
  ...
  void enter(cl_command_queue *commandQueue, cl_uint *numObjects,
             const cl_mem **memObjects, cl_uint *numEventsInWaitList,
             const cl_event **eventWaitList, cl_event **event) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  clEnqueueAcquireGLObjectsTracer(clEnqueueAcquireGLObjectsTracer &) = delete;
  clEnqueueAcquireGLObjectsTracer &
  operator=(clEnqueueAcquireGLObjectsTracer &) = delete;
...
public:
  ...
  clEnqueueReleaseGLObjectsTracer(clEnqueueReleaseGLObjectsTracer &) = delete;
  clEnqueueReleaseGLObjectsTracer &
  operator=(clEnqueueReleaseGLObjectsTracer &) = delete;
...
public:
  ...
  void enter(cl_mem *memobj, cl_gl_object_type **glObjectType,
  ...
  clGetGLObjectInfoTracer(clGetGLObjectInfoTracer &) = delete;
  clGetGLObjectInfoTracer &operator=(clGetGLObjectInfoTracer &) = delete;
...
public:
  ...
  void enter(cl_mem *memobj, cl_gl_texture_info *paramName,
             size_t *paramValueSize, void **paramValue,
             size_t **paramValueSizeRet) {
    assert(state == TRACING_NOTIFY_STATE_NOTHING_CALLED);
  ...
  clGetGLTextureInfoTracer(clGetGLTextureInfoTracer &) = delete;
  clGetGLTextureInfoTracer &operator=(clGetGLTextureInfoTracer &) = delete;
