...
const std::map<cl_command_type, CommandNameDevType> CommandTypeToNames = {
    ...
    {CL_COMMAND_READ_GLOBAL_VARIABLE_INTEL,
     {"CL_COMMAND_READ_GLOBAL_VARIABLE_INTEL", "Read Device Global",
      CL_DEV_CMD_READ_GLOBAL}},

    {CL_COMMAND_WRITE_GLOBAL_VARIABLE_INTEL,
     {"CL_COMMAND_WRITE_GLOBAL_VARIABLE_INTEL", "Write Device Global",
      CL_DEV_CMD_WRITE_GLOBAL}},

    {CL_COMMAND_READ_HOST_PIPE_INTEL,
     {"CL_COMMAND_READ_HOST_PIPE_INTEL", "Read Host Pipe",
      CL_DEV_CMD_READ_HOST_PIPE}},

    {CL_COMMAND_WRITE_HOST_PIPE_INTEL,
     {"CL_COMMAND_WRITE_HOST_PIPE_INTEL", "Write Host Pipe",
      CL_DEV_CMD_WRITE_HOST_PIPE}},
