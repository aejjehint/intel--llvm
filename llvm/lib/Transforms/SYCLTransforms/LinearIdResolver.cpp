...
bool LinearIdResolverPass::runImpl(Module &M, CallGraph *CG) {
  ...
  for (Function &F : M) {
    ...
    for (auto &N : *(*CG)[&F]) {
      ...
      if (isGetGlobalLinearId(CalleeName))
        WorkList.push_back(std::make_pair(CI, LK_GLOBAL));
      else if (isGetLocalLinearId(CalleeName))
...
void LinearIdResolverPass::replaceGetGlobalLinearId(Module *M, CallInst *CI) {
  ...
  static std::string IdName = mangledGetGID();
  ...
  static std::string OffName = mangledGetGlobalOffset();
  ...
  static std::string SizeName = mangledGetGlobalSize();
...
void LinearIdResolverPass::replaceGetLocalLinearId(Module *M, CallInst *CI) {
  ...
  static std::string IdName = mangledGetLID();
  ...
  static std::string SizeName = mangledGetLocalSize();
