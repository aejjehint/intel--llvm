...
ResolveSubGroupWICallPass::replaceGetSubGroupSize(Instruction *InsertBefore,
  ...
  auto *LocalSize = createWIFunctionCall(M, Builder, LocalSizeName, VecDimVar);
  ConstantInt *Zero =
  ...
  auto *LocalId = createWIFunctionCall(M, Builder, LocalIdName, VecDimVar);
...
Value *ResolveSubGroupWICallPass::replaceGetEnqueuedNumSubGroups(
  ...
  IRBuilder<> Builder(InsertBefore);
  auto *EnqdLsz0 = createWIFunctionCall(M, Builder, EnqdLocalSizeName,
                                        Builder.getInt32(0), "enqdlz0");
  auto *EnqdLsz1 = createWIFunctionCall(M, Builder, EnqdLocalSizeName,
                                        Builder.getInt32(1), "enqdlz1");
  auto *EnqdLsz2 = createWIFunctionCall(M, Builder, EnqdLocalSizeName,
                                        Builder.getInt32(2), "enqdlz2");
...
ResolveSubGroupWICallPass::replaceGetNumSubGroups(Instruction *InsertBefore,
  ...
  Module *M = InsertBefore->getModule();
  IRBuilder<> Builder(InsertBefore);
  auto *Lsz0 = createWIFunctionCall(M, Builder, LocalSizeName,
                                    Builder.getInt32(0), "lsz0");
  auto *Lsz1 = createWIFunctionCall(M, Builder, LocalSizeName,
                                    Builder.getInt32(1), "lsz1");
  auto *Lsz2 = createWIFunctionCall(M, Builder, LocalSizeName,
                                    Builder.getInt32(2), "lsz2");
...
ResolveSubGroupWICallPass::replaceGetSubGroupId(Instruction *InsertBefore,
  ...
  CallInst *Lid2 =
      createWIFunctionCall(M, Builder, IdName, Builder.getInt32(2), "lid2");
  CallInst *Lid1 =
      createWIFunctionCall(M, Builder, IdName, Builder.getInt32(1), "lid1");
  CallInst *Lid0 =
      createWIFunctionCall(M, Builder, IdName, Builder.getInt32(0), "lid0");
  assert(Lid0 && Lid1 && Lid2 && "Can't create get_local_id calls");

  // call get_local_size(2), get_local_size(1), get_local_size(0)
  CallInst *Lsz2 =
      createWIFunctionCall(M, Builder, SizeName, Builder.getInt32(2), "lsz2");
  CallInst *Lsz1 =
      createWIFunctionCall(M, Builder, SizeName, Builder.getInt32(1), "lsz1");
  CallInst *Lsz0 =
      createWIFunctionCall(M, Builder, SizeName, Builder.getInt32(0), "lsz0");
