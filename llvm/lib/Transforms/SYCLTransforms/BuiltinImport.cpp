...
void BuiltinImportPass::UpdateSvmlBuiltin(const FuncVec &SvmlFunctions,
  ...
  if (CPUPrefix == getCPUPrefixSSE(true) ||
      CPUPrefix == getCPUPrefixSSE(false) ||
      CPUPrefix == getCPUPrefixAVX(true) ||
      CPUPrefix == getCPUPrefixAVX(false) ||
      CPUPrefix == getCPUPrefixAVX2(true) ||
      CPUPrefix == getCPUPrefixAVX2(false) ||
      CPUPrefix == getCPUPrefixAVX512(true) ||
      CPUPrefix == getCPUPrefixAVX512(false) ||
      CPUPrefix == getCPUPrefixAMX(true) ||
      CPUPrefix == getCPUPrefixAMX(false)) {
...
void BuiltinImportPass::GetCalledFunctions(const Function *F,
  ...
  for (auto &I : instructions(F)) {
    ...
    if (CalledFunc->getName().starts_with("__ocl_svml_shared"))
