...
; CHECK-ARG: call i32 @foo(ptr addrspace(1) noundef {{.*}}, i32 noundef {{.*}}, i64 noundef {{.*}}, ptr addrspace(3) noalias null, ptr noalias %pWorkDim, ptr noalias %pWGId, [4 x i64] %BaseGlbId, ptr noalias null, ptr noalias %RuntimeHandle)
