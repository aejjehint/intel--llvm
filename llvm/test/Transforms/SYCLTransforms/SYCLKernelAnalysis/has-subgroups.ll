...
; CHECK: define void @test17({{.*}} [[ATTR_HAS_SG]] {{.*}} !kernel_has_sub_groups [[SGMD_TRUE]]
define void @test17(ptr addrspace(1) noundef align 4 %dst) !kernel_arg_base_type !1 !arg_type_null_val !2 {
entry:
  %0 = tail call i32 @_Z30sub_group_clustered_reduce_addij(i32 noundef 0, i32 noundef 1) #0
  ret void
}

; CHECK: define void @test18({{.*}} [[ATTR_HAS_SG]] {{.*}} !kernel_has_sub_groups [[SGMD_TRUE]]
define void @test18(ptr addrspace(1) noundef align 4 %dst) !kernel_arg_base_type !1 !arg_type_null_val !2 {
entry:
  %0 = tail call i32 @_Z30sub_group_clustered_reduce_andij(i32 noundef 0, i32 noundef 1) #0
  ret void
}

; CHECK: define void @test19({{.*}} [[ATTR_HAS_SG]] {{.*}} !kernel_has_sub_groups [[SGMD_TRUE]]
define void @test19(ptr addrspace(1) noundef align 4 %dst) !kernel_arg_base_type !1 !arg_type_null_val !2 {
entry:
  %0 = tail call i32 @_Z38sub_group_clustered_reduce_logical_andij(i32 noundef 0, i32 noundef 1) #0
  ret void
}

; CHECK: define void @test20({{.*}} [[ATTR_HAS_SG]] {{.*}} !kernel_has_sub_groups [[SGMD_TRUE]]
define void @test20(ptr addrspace(1) noundef align 4 %dst) !kernel_arg_base_type !1 !arg_type_null_val !2 {
entry:
  %0 = tail call i32 @_Z37sub_group_clustered_reduce_logical_orij(i32 noundef 0, i32 noundef 1) #0
  ret void
}

; CHECK: define void @test21({{.*}} [[ATTR_HAS_SG]] {{.*}} !kernel_has_sub_groups [[SGMD_TRUE]]
define void @test21(ptr addrspace(1) noundef align 4 %dst) !kernel_arg_base_type !1 !arg_type_null_val !2 {
entry:
  %0 = tail call i32 @_Z38sub_group_clustered_reduce_logical_xorij(i32 noundef 0, i32 noundef 1) #0
  ret void
}

; CHECK: define void @test22({{.*}} [[ATTR_HAS_SG]] {{.*}} !kernel_has_sub_groups [[SGMD_TRUE]]
define void @test22(ptr addrspace(1) noundef align 4 %dst) !kernel_arg_base_type !1 !arg_type_null_val !2 {
entry:
  %0 = tail call i32 @_Z30sub_group_clustered_reduce_maxij(i32 noundef 0, i32 noundef 1) #0
  ret void
}

; CHECK: define void @test23({{.*}} [[ATTR_HAS_SG]] {{.*}} !kernel_has_sub_groups [[SGMD_TRUE]]
define void @test23(ptr addrspace(1) noundef align 4 %dst) !kernel_arg_base_type !1 !arg_type_null_val !2 {
entry:
  %0 = tail call i32 @_Z30sub_group_clustered_reduce_minij(i32 noundef 0, i32 noundef 1) #0
  ret void
}

; CHECK: define void @test24({{.*}} [[ATTR_HAS_SG]] {{.*}} !kernel_has_sub_groups [[SGMD_TRUE]]
define void @test24(ptr addrspace(1) noundef align 4 %dst) !kernel_arg_base_type !1 !arg_type_null_val !2 {
entry:
  %0 = tail call i32 @_Z30sub_group_clustered_reduce_mulij(i32 noundef 0, i32 noundef 1) #0
  ret void
}

; CHECK: define void @test25({{.*}} [[ATTR_HAS_SG]] {{.*}} !kernel_has_sub_groups [[SGMD_TRUE]]
define void @test25(ptr addrspace(1) noundef align 4 %dst) !kernel_arg_base_type !1 !arg_type_null_val !2 {
entry:
  %0 = tail call i32 @_Z29sub_group_clustered_reduce_orij(i32 noundef 0, i32 noundef 1) #0
  ret void
}

; CHECK: define void @test26({{.*}} [[ATTR_HAS_SG]] {{.*}} !kernel_has_sub_groups [[SGMD_TRUE]]
define void @test26(ptr addrspace(1) noundef align 4 %dst) !kernel_arg_base_type !1 !arg_type_null_val !2 {
entry:
  %0 = tail call i32 @_Z30sub_group_clustered_reduce_xorij(i32 noundef 0, i32 noundef 1) #0
  ret void
}
...
; Function Attrs: convergent
declare i32 @_Z30sub_group_clustered_reduce_addij(i32 noundef, i32 noundef) #0

; Function Attrs: convergent
declare i32 @_Z30sub_group_clustered_reduce_andij(i32 noundef, i32 noundef) #0

; Function Attrs: convergent
declare i32 @_Z38sub_group_clustered_reduce_logical_andij(i32 noundef, i32 noundef) #0

; Function Attrs: convergent
declare i32 @_Z37sub_group_clustered_reduce_logical_orij(i32 noundef, i32 noundef) #0

; Function Attrs: convergent
declare i32 @_Z38sub_group_clustered_reduce_logical_xorij(i32 noundef, i32 noundef) #0

; Function Attrs: convergent
declare i32 @_Z30sub_group_clustered_reduce_maxij(i32 noundef, i32 noundef) #0

; Function Attrs: convergent
declare i32 @_Z30sub_group_clustered_reduce_minij(i32 noundef, i32 noundef) #0

; Function Attrs: convergent
declare i32 @_Z30sub_group_clustered_reduce_mulij(i32 noundef, i32 noundef) #0

; Function Attrs: convergent
declare i32 @_Z29sub_group_clustered_reduce_orij(i32 noundef, i32 noundef) #0

; Function Attrs: convergent
declare i32 @_Z30sub_group_clustered_reduce_xorij(i32 noundef, i32 noundef) #0
...
!sycl.kernels = !{!0}
!0 = !{ptr @test1, ptr @test2, ptr @test3, ptr @test4, ptr @test5, ptr @test6, ptr @test7, ptr @test8, ptr @test9, ptr @test10, ptr @test11, ptr @test12, ptr @test13, ptr @test14, ptr @test15, ptr @test16, ptr @test17, ptr @test18, ptr @test19, ptr @test20, ptr @test21, ptr @test22, ptr @test23, ptr @test24, ptr @test25, ptr @test26}
!1 = !{!"int*"}
