...
define dso_local i32 @bar(ptr addrspace(1) %pipe0, ptr addrspace(1) %pipe1) #1 !kernel_arg_target_ext_type !4 {
entry:
...
; CHECK: call i32 @bar
; Function Attrs: convergent noinline norecurse nounwind
define dso_local i32 @foo(ptr addrspace(1) %pipe0, ptr addrspace(1) %pipe1) #1 !kernel_arg_target_ext_type !4 {
entry:
  %pipe0.addr = alloca ptr addrspace(1), align 8
  %pipe1.addr = alloca ptr addrspace(1), align 8
  store ptr addrspace(1) %pipe0, ptr %pipe0.addr, align 8, !tbaa !5
...
; Function Attrs: convergent noinline norecurse nounwind
define dso_local void @dummy(ptr addrspace(1) %pipe0, ptr addrspace(1) %pipe1) #1 !kernel_arg_target_ext_type !10 {
entry:
  %pipe0.addr = alloca ptr addrspace(1), align 8
  %pipe1.addr = alloca ptr addrspace(1), align 8
  %result = alloca i32, align 4
...
; CHECK: call i32 @foo
; Function Attrs: convergent noinline norecurse nounwind
define dso_local i32 @readPipeHelper(ptr addrspace(1) %pipe0, ptr addrspace(1) %pipe1) #1 !kernel_arg_target_ext_type !4 {
entry:
  %pipe0.addr = alloca ptr addrspace(1), align 8
  %pipe1.addr = alloca ptr addrspace(1), align 8
  store ptr addrspace(1) %pipe0, ptr %pipe0.addr, align 8, !tbaa !5
...
; Function Attrs: convergent norecurse nounwind
define dso_local void @readFromFileViaPipe3(ptr addrspace(1) %pipe0, ptr addrspace(1) %pipe1, ptr addrspace(1) %pipe2, ptr addrspace(1) %pipe3, ptr addrspace(1) noundef align 4 %data) #2 !kernel_arg_addr_space !22 !kernel_arg_access_qual !23 !kernel_arg_type !24 !kernel_arg_base_type !24 !kernel_arg_type_qual !25 !kernel_arg_host_accessible !26 !kernel_arg_pipe_depth !27 !kernel_arg_pipe_io !28 !kernel_arg_buffer_location !29 !kernel_arg_target_ext_type !30 {
entry:
  %pipe0.addr = alloca ptr addrspace(1), align 8
  %pipe1.addr = alloca ptr addrspace(1), align 8
  %pipe2.addr = alloca ptr addrspace(1), align 8
...
!4 = !{!"spirv.Pipe_0", !"spirv.Pipe_0"}
!5 = !{!6, !6, i64 0}
!6 = !{!"omnipotent char", !7, i64 0}
!7 = !{!"Simple C/C++ TBAA"}
!8 = !{!9, !9, i64 0}
!9 = !{!"int", !6, i64 0}
!10 = !{!"spirv.Pipe_1", !"spirv.Pipe_0"}
...
!18 = !{!"", !"", !"", !""}
!19 = !{!"spirv.Pipe_0", !"spirv.Pipe_0", !"spirv.Pipe_0", !""}
!20 = !{!21, !21, i64 0}
...
!29 = !{!"", !"", !"", !"", !""}
!30 = !{!"spirv.Pipe_0", !"spirv.Pipe_0", !"spirv.Pipe_0", !"spirv.Pipe_1", !""}
