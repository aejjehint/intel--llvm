...
; CHECK-NEXT: #dbg_declare(ptr %__ocl_dbg_gid0, [[fooDbgMD0:![0-9]+]], !DIExpression(),
; CHECK-NEXT: %__ocl_dbg_gid1 = alloca i64, align 8
; CHECK-NEXT: #dbg_declare(ptr %__ocl_dbg_gid1, [[fooDbgMD1:![0-9]+]], !DIExpression(),
; CHECK-NEXT: %__ocl_dbg_gid2 = alloca i64, align 8
; CHECK-NEXT: #dbg_declare(ptr %__ocl_dbg_gid2, [[fooDbgMD2:![0-9]+]], !DIExpression(),
...
; CHECK-LABEL: @test
; CHECK: %__ocl_dbg_gid0 = alloca i64, align 8
; CHECK-NEXT: #dbg_declare(ptr %__ocl_dbg_gid0, [[DbgMD0:![0-9]+]], !DIExpression(),
; CHECK-NEXT: %__ocl_dbg_gid1 = alloca i64, align 8
; CHECK-NEXT: #dbg_declare(ptr %__ocl_dbg_gid1, [[DbgMD1:![0-9]+]], !DIExpression(),
; CHECK-NEXT: %__ocl_dbg_gid2 = alloca i64, align 8
; CHECK-NEXT: #dbg_declare(ptr %__ocl_dbg_gid2, [[DbgMD2:![0-9]+]], !DIExpression(),
; CHECK-NEXT: %GlobalID_0 = call i64 @_Z13get_global_idj(i32 0)
; CHECK-NEXT: store volatile i64 %GlobalID_0, ptr %__ocl_dbg_gid0, align 8
; CHECK-NEXT: %GlobalID_1 = call i64 @_Z13get_global_idj(i32 1)
; CHECK-NEXT: store volatile i64 %GlobalID_1, ptr %__ocl_dbg_gid1, align 8
