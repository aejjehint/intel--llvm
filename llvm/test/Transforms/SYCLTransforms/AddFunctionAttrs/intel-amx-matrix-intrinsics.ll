...
define void @load_mad_store(ptr addrspace(4) %ptr, i64 %Stride, <616 x i8> %x, <560 x i8> %y) {
  ...
  call void @llvm.experimental.matrix.prefetch.p4(ptr addrspace(4) %ptr, i32 16, i32 32, i32 0, i64 4096, i64 16, metadata !"matrix.rowmajor")
  ret void
}
...
declare void @llvm.experimental.matrix.prefetch.p4(ptr addrspace(4) nocapture readonly, i32 immarg, i32 immarg, i32 immarg, i64, i64 immarg, metadata)
...
; CHECK: call {{.*}} @llvm.experimental.matrix.prefetch.{{.*}} #[[#ATTR_ID:]]
