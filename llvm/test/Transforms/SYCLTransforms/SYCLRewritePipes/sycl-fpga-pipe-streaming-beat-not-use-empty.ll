...
;   and StreamingBeat data type bit size (64) is less than BitsPerSymbol (128) property of the pipe.

; Checks that the following error is thrown:
; CHECK-ERROR: error: The width of the data type carried by D2HPipeID must be a multiple of bits per symbol.
