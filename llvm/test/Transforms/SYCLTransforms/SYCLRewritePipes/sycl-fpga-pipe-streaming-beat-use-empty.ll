...
; RUN: opt -sycl-kernel-builtin-lib=%t.rtl.bc -passes=sycl-kernel-rewrite-pipes -S %s -disable-output

; Checks that no error is thrown because:
;   StreamingBeat struct is instantiated with use_Empty = true.
...
@anon.3 = private unnamed_addr constant [17 x i8] c"{sideband:empty}\00", align 1

; Constructor of a StreamingBeat struct, whose use_Empty = true and data type is i64
define internal void @StreamingBeatConstructor(ptr addrspace(4) align 8 %this, i64 %_data, i1 zeroext %_sop, i1 zeroext %_eop, i32 %_empty) {
entry:
  %data = getelementptr inbounds %"struct.sycl::_V1::ext::intel::experimental::StreamingBeat", ptr addrspace(4) %this, i64 0, i32 0, !spirv.Decorations !15534
  ...
  %sop = getelementptr inbounds %"struct.sycl::_V1::ext::intel::experimental::StreamingBeat", ptr addrspace(4) %this, i64 0, i32 1, !spirv.Decorations !15538
  ...
  %eop = getelementptr inbounds %"struct.sycl::_V1::ext::intel::experimental::StreamingBeat", ptr addrspace(4) %this, i64 0, i32 2, !spirv.Decorations !15542
  ...
  %empty = getelementptr inbounds %"struct.sycl::_V1::ext::intel::experimental::StreamingBeat", ptr addrspace(4) %this, i64 0, i32 3, !spirv.Decorations !15546
  %3 = call ptr addrspace(4) @llvm.ptr.annotation.p4.p0(ptr addrspace(4) %empty, ptr nonnull @anon.3, ptr undef, i32 undef, ptr undef)
  store i32 %_empty, ptr addrspace(4) %3, align 4
  ret void
}
...
entry:
  ...
  call void @StreamingBeatConstructor(ptr addrspace(4) align 8 %ref.tmp.ascast, i64 1, i1 zeroext true, i1 zeroext true, i32 0)
