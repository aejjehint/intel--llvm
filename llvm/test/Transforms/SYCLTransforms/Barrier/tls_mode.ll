...
; CHECK: define internal i64 @foo()
define internal i64 @foo() #0 {
entry:
; CHECK: %LocalId_0 = load i64, ptr @__LocalIds, align 8
; CHECK: ret i64 %LocalId_0

  %call = call i64 @_Z12get_local_idj(i32 0) #4
  ret i64 %call
}
...
;DEBUGIFY: WARNING: Instruction with empty DebugLoc in function test -- %pSB = call noalias ptr @get_special_buffer.()
