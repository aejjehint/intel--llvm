...
entry:
  ...
  br i1 %cmp0, label %atomic.free.red.local.update.exit, label %red.update.body.to.tree.preheader
...
red.update.body.to.tree:
  ...
  br i1 %cmp1, label %atomic.free.red.local.update.exit, label %red.update.body.to.tree

atomic.free.red.local.update.exit:
