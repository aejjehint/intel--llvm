; RUN: opt -passes=sycl-kernel-add-function-attrs,simplifycfg -S < %s -enable-debugify -disable-output 2>&1 | FileCheck -check-prefix=DEBUGIFY %s
; RUN: opt -passes=sycl-kernel-add-function-attrs,simplifycfg -S < %s | FileCheck %s
...
; <label>:26                                      ; preds = %bb.nph, %26
  ...
  %scevgep = getelementptr i32, ptr addrspace(1) %cols, i64 %tmp7
  %scevgep8 = getelementptr float, ptr addrspace(1) %val, i64 %tmp7
  %27 = load i32, ptr addrspace(1) %scevgep, align 4
  %28 = load float, ptr addrspace(1) %scevgep8, align 4
  %29 = sext i32 %27 to i64
  %30 = getelementptr inbounds float, ptr addrspace(1) %vec, i64 %29
...
._crit_edge:                                      ; preds = %26, %16
  ...
  store volatile float %mySum.0.lcssa, ptr addrspace(3) %14, align 4
...
; <label>:36                                      ; preds = %._crit_edge
  ...
  %39 = getelementptr inbounds [128 x float], ptr addrspace(3) @opencl_spmv_csr_vector_kernel_local_partialSums, i64 0, i64 %38
  %40 = load volatile float, ptr addrspace(3) %39, align 4
  %41 = load volatile float, ptr addrspace(3) %14, align 4
  %42 = fadd float %41, %40
  store volatile float %42, ptr addrspace(3) %14, align 4
  br label %43
...
; <label>:45                                      ; preds = %43
  ...
  %48 = getelementptr inbounds [128 x float], ptr addrspace(3) @opencl_spmv_csr_vector_kernel_local_partialSums, i64 0, i64 %47
  %49 = load volatile float, ptr addrspace(3) %48, align 4
  %50 = load volatile float, ptr addrspace(3) %14, align 4
  %51 = fadd float %50, %49
  store volatile float %51, ptr addrspace(3) %14, align 4
  br label %52
...
; <label>:54                                      ; preds = %52
  ...
  %57 = getelementptr inbounds [128 x float], ptr addrspace(3) @opencl_spmv_csr_vector_kernel_local_partialSums, i64 0, i64 %56
  %58 = load volatile float, ptr addrspace(3) %57, align 4
  %59 = load volatile float, ptr addrspace(3) %14, align 4
  %60 = fadd float %59, %58
  store volatile float %60, ptr addrspace(3) %14, align 4
  br label %61
...
; <label>:63                                      ; preds = %61
  ...
  %66 = getelementptr inbounds [128 x float], ptr addrspace(3) @opencl_spmv_csr_vector_kernel_local_partialSums, i64 0, i64 %65
  %67 = load volatile float, ptr addrspace(3) %66, align 4
  %68 = load volatile float, ptr addrspace(3) %14, align 4
  %69 = fadd float %68, %67
  store volatile float %69, ptr addrspace(3) %14, align 4
  br label %70
...
; <label>:72                                      ; preds = %70
  ...
  %75 = getelementptr inbounds [128 x float], ptr addrspace(3) @opencl_spmv_csr_vector_kernel_local_partialSums, i64 0, i64 %74
  %76 = load volatile float, ptr addrspace(3) %75, align 4
  %77 = load volatile float, ptr addrspace(3) %14, align 4
  %78 = fadd float %77, %76
  store volatile float %78, ptr addrspace(3) %14, align 4
  br label %79
...
; <label>:80                                      ; preds = %79
  %81 = load volatile float, ptr addrspace(3) %14, align 4
  %82 = getelementptr inbounds float, ptr addrspace(1) %out, i64 %17
  store float %81, ptr addrspace(1) %82, align 4
  ret void
