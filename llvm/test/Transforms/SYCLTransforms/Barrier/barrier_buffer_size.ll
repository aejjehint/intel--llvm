...
;DEBUGIFY: WARNING: Instruction with empty DebugLoc in function main -- %pSB = call noalias ptr @get_special_buffer.()
...
;DEBUGIFY: WARNING: Instruction with empty DebugLoc in function __Vectorized_.main -- %pSB = call noalias ptr @get_special_buffer.()
...
;DEBUGIFY: WARNING: Instruction with empty DebugLoc in function foo -- %pSB = call noalias ptr @get_special_buffer.()
