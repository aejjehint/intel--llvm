...
define void @_ZGVeN16uu___omp_offloading_801_b809e_test_target_device_IP_test_target_device_clause__l40(ptr addrspace(1) %"ascast$test_target_device_clause$ARRAY$_277", i64 %"ascast$test_target_device_clause$DEV$_277.val.zext") !dbg !4 {
newFuncRoot:
; CHECK-LABEL: newFuncRoot:
; CHECK-NEXT:  #dbg_value(ptr addrspace(1) %"ascast$test_target_device_clause$ARRAY$_277", {{.*}}, !DIExpression(DW_OP_deref),
