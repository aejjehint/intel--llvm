...
;DEBUGIFY: WARNING: Instruction with empty DebugLoc in function _ZGVbN4v_foo --  %pSB = call noalias ptr @get_special_buffer.()
...
;DEBUGIFY: WARNING: Instruction with empty DebugLoc in function _ZGVbN4u_test --  %pSB = call noalias ptr @get_special_buffer.()
