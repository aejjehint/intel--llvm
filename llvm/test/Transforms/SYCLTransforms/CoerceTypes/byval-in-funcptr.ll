...
; Check the function pointer with byval argument is transformed.
...
; CHECK: declare void @_Z14function1ArrayIN4sycl3_V13ext5intel4pipeI8my_pipe2fLi12EEEEv9FixedVectIfLi2EE(<2 x float>)
