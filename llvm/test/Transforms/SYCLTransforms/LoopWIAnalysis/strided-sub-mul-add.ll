...
; CHECK-DAG: UNI  <8 x i64> splat (i64 2)
; CHECK-DAG: STR    %6 = add <8 x i64> %5, splat (i64 2)
; CHECK-DAG: UNI  <8 x i64> splat (i64 3)
; CHECK-DAG: STR    %7 = mul <8 x i64> %6, splat (i64 3)
; CHECK-DAG: UNI  <8 x i64> splat (i64 1)
; CHECK-DAG: STR    %8 = add <8 x i64> %7, splat (i64 1)
