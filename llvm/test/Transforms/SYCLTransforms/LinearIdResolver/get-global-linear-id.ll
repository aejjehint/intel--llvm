...
; CHECK-DAG: declare i64 @_Z13get_global_idj(i32) [[ATTR]]
; CHECK-DAG: declare i64 @_Z17get_global_offsetj(i32) [[ATTR]]
; CHECK-DAG: declare i64 @_Z15get_global_sizej(i32) [[ATTR]]
