...
define ptr @test_bgra8888(ptr addrspace(1) %srcimg, i32 %sampler, <2 x i32> %vecinit4) !kernel_arg_base_type !0 !kernel_arg_target_ext_type !1 {
entry:
