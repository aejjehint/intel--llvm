...
; CHECK-NEXT:    store <4 x i32> splat (i32 1), ptr [[ALLOCAWGRESULT]], align 16
; CHECK-NEXT:    call void @dummy_barrier.()
...
; DEBUGIFY: WARNING: Instruction with empty DebugLoc in function _ZGVeN4_build_hash_table --  store <4 x i32> splat (i32 1), ptr %AllocaWGResult, align 16
