...
; CHECK-DAG: store <16 x double> splat (double 0x7FF0000000000000{{.*}} ptr [[D_POS_INF16:%.*]],
; CHECK-DAG: store <16 x double> splat (double 0xFFF0000000000000{{.*}} ptr [[D_NEG_INF16:%.*]],
; CHECK-DAG: store <16 x float> splat (float 0x7FF0000000000000){{.*}} ptr [[F_POS_INF16:%.*]],
; CHECK-DAG: store <16 x float> splat (float 0xFFF0000000000000){{.*}} ptr [[F_NEG_INF16:%.*]],
