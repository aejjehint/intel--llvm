...
; CHECK-NEXT: store i32 -2147483648, ptr %AllocaWGResult
; CHECK-NEXT: call void @dummy_barrier.()
; CHECK-NOT: %call1 = tail call i32 @_Z29work_group_scan_exclusive_maxi(i32 %0)
; CHECK: %CallWGForItem = call i32 @_Z29work_group_scan_exclusive_maxiPi(i32 %0, ptr %AllocaWGResult)
; CHECK-NEXT: call void @_Z18work_group_barrierj(i32 1)
; CHECK: store i32 %CallWGForItem, ptr addrspace(1) %arrayidx2, align 1

define void @wg_test_scan(ptr addrspace(1) nocapture %a, ptr addrspace(1) nocapture %b) nounwind {
entry:
...
; CHECK-NEXT: store <4 x i32> splat (i32 -2147483648), ptr %AllocaWGResult
; CHECK-NEXT: call void @dummy_barrier.()
; CHECK-NOT: call <4 x i32> @_Z29work_group_scan_exclusive_maxDv4_i(<4 x i32> %1)
; CHECK: %CallWGForItem = call <4 x i32> @_Z29work_group_scan_exclusive_maxDv4_iPS_(<4 x i32> %1, ptr %AllocaWGResult)
; CHECK-NEXT: call void @_Z18work_group_barrierj(i32 1)
; CHECK: store <4 x i32> %CallWGForItem, ptr addrspace(1) {{.*}}, align 1

define void @__Vectorized_.wg_test_scan(ptr addrspace(1) nocapture %a, ptr addrspace(1) nocapture %b) nounwind {
entry:
  %call = tail call i32 @_Z13get_global_idj(i32 0) nounwind readnone
...
; CHECK: declare i32 @_Z29work_group_scan_exclusive_maxiPi(i32, ptr)
; CHECK: declare <4 x i32> @_Z29work_group_scan_exclusive_maxDv4_iPS_(<4 x i32>, ptr)
...
!17 = !{!"vectorized_kernel", ptr @__Vectorized_.wg_test_scan}
!18 = !{!"vectorized_width", i32 1}
!19 = !{!"kernel_wrapper", null}
!20 = !{!"scalar_kernel", null}
!21 = !{ptr @__Vectorized_.wg_test_scan, !22}
...
!27 = !{!"scalar_kernel", ptr @wg_test_scan}
!28 = !{!29, !30}
...
;DEBUGIFY: WARNING: Instruction with empty DebugLoc in function wg_test_scan -- store i32 -2147483648, ptr %AllocaWGResult, align 4
...
;DEBUGIFY: WARNING: Instruction with empty DebugLoc in function __Vectorized_.wg_test_scan -- store <4 x i32> splat (i32 -2147483648), ptr %AllocaWGResult, align 16
