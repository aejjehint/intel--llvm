...
; CHECK-NEXT:    store <16 x i32> zeroinitializer, ptr [[ALLOCAWGRESULT5]], align 64
; CHECK-NEXT:    [[ALLOCAWGRESULT3:%.*]] = alloca <16 x i16>, align 32
; CHECK-NEXT:    store <16 x i16> splat (i16 -1), ptr [[ALLOCAWGRESULT3]], align 32
; CHECK-NEXT:    [[ALLOCAWGRESULT1:%.*]] = alloca i32, align 4
; CHECK-NEXT:    store i32 0, ptr [[ALLOCAWGRESULT1]], align 4
; CHECK-NEXT:    [[ALLOCAWGRESULT:%.*]] = alloca i16, align 2
; CHECK-NEXT:    store i16 -1, ptr [[ALLOCAWGRESULT]], align 2
; CHECK-NEXT:    call void @dummy_barrier.()
; CHECK-NEXT:    [[CALLWGFORITEM:%.*]] = call i16 @_Z29work_group_reduce_bitwise_andsPs(i16 noundef signext 4, ptr [[ALLOCAWGRESULT]])
; CHECK-NEXT:    call void @_Z18work_group_barrierj(i32 1)
; CHECK-NEXT:    [[LOADWGFINALRESULT:%.*]] = load i16, ptr [[ALLOCAWGRESULT]], align 2
; CHECK-NEXT:    [[CALLFINALIZEWG:%.*]] = call i16 @_Z30__finalize_work_group_identitys(i16 [[LOADWGFINALRESULT]])
; CHECK-NEXT:    store i16 -1, ptr [[ALLOCAWGRESULT]], align 2
; CHECK-NEXT:    call void @dummy_barrier.()
; CHECK-NEXT:    [[CALLWGFORITEM2:%.*]] = call i32 @_Z28work_group_reduce_logical_oriPi(i32 noundef 8, ptr [[ALLOCAWGRESULT1]])
; CHECK-NEXT:    call void @_Z18work_group_barrierj(i32 1)
; CHECK-NEXT:    [[LOADWGFINALRESULT:%.*]] = load i32, ptr [[ALLOCAWGRESULT1]], align 4
; CHECK-NEXT:    [[CALLFINALIZEWG:%.*]] = call i32 @_Z30__finalize_work_group_identityi(i32 [[LOADWGFINALRESULT]])
; CHECK-NEXT:    store i32 0, ptr [[ALLOCAWGRESULT1]], align 4
; CHECK-NEXT:    call void @dummy_barrier.()
; CHECK-NEXT:    [[CALLWGFORITEM4:%.*]] = call <16 x i16> @_Z29work_group_reduce_bitwise_andDv16_sPS_(<16 x i16> noundef splat (i16 4), ptr [[ALLOCAWGRESULT3]])
; CHECK-NEXT:    call void @_Z18work_group_barrierj(i32 1)
; CHECK-NEXT:    [[LOADWGFINALRESULT:%.*]] = load <16 x i16>, ptr [[ALLOCAWGRESULT3]], align 32
; CHECK-NEXT:    [[CALLFINALIZEWG:%.*]] = call <16 x i16> @_Z40__finalize_work_group_reduce_bitwise_andDv16_s(<16 x i16> [[LOADWGFINALRESULT]])
; CHECK-NEXT:    store <16 x i16> splat (i16 -1), ptr [[ALLOCAWGRESULT3]], align 32
; CHECK-NEXT:    call void @dummy_barrier.()
; CHECK-NEXT:    [[CALLWGFORITEM6:%.*]] = call <16 x i32> @_Z28work_group_reduce_logical_orDv16_iPS_(<16 x i32> noundef splat (i32 8), ptr [[ALLOCAWGRESULT5]])
; CHECK-NEXT:    call void @_Z18work_group_barrierj(i32 1)
; CHECK-NEXT:    [[LOADWGFINALRESULT7:%.*]] = load <16 x i32>, ptr [[ALLOCAWGRESULT5]], align 64
