...
; CHECK-NEXT:    [[LLSIZE32:%.*]] = trunc i64 [[LLSIZE_P1]] to i32
; CHECK-NEXT:    [[SORT_SIZE:%.*]] = mul nuw nsw  i32 4, [[LLSIZE32]]
; CHECK-NEXT:    tail call void @_Z73__devicelib_default_work_group_private_sort_close_ascending_p1i8_u32_p1i8Dv4_PU3AS4cjS0_Dv4_j(<4 x ptr addrspace(4)> [[VECTOR_DATA]], i32 [[SORT_SIZE]], ptr addrspace(4) [[NEW_SCRATCH]], <4 x i32> splat (i32 -1))
; CHECK-NEXT:    call void @dummy_barrier.()
...
; CHECK-NEXT:    [[LLSIZE32:%.*]] = trunc i64 [[LLSIZE_P1]] to i32
; CHECK-NEXT:    [[SORT_SIZE:%.*]] = mul nuw nsw  i32 4, [[LLSIZE32]]
; CHECK-NEXT:    tail call void @_Z75__devicelib_default_work_group_private_sort_spread_ascending_p1i64_u32_p1i8Dv8_PU3AS4ljPU3AS4cDv8_j(<8 x ptr addrspace(4)> [[VECTOR_DATA]], i32 [[SORT_SIZE]], ptr addrspace(4) [[NEW_SCRATCH]], <8 x i32> splat (i32 -1))
; CHECK-NEXT:    call void @dummy_barrier.()
...
; CHECK:         call void @_Z18work_group_barrierj(i32 1)
; CHECK-NEXT:    tail call void @_Z67__devicelib_default_work_group_joint_sort_descending_p1f64_u32_p1i8Dv16_PU3AS4djPU3AS4cDv16_j(<16 x ptr addrspace(4)> [[VECTOR_DATA:%.*]], i32 4, ptr addrspace(4) [[NEW_SCRATCH:%.*]], <16 x i32> splat (i32 -1))
; CHECK-NEXT:    call void @dummy_barrier.()
...
; CHECK-NEXT:    [[LLSIZE32:%.*]] = trunc i64 [[LLSIZE_P1]] to i32
; CHECK-NEXT:    [[SORT_SIZE:%.*]] = mul nuw nsw  i32 4, [[LLSIZE32]]
; CHECK-NEXT:    tail call void @_Z79__devicelib_default_work_group_private_sort_close_ascending_p3f64_p3i8_u32_p1i8Dv4_PU3AS4dDv4_PU3AS4cjS3_Dv4_j(<4 x ptr addrspace(4)> [[VECTOR_DATA1]], <4 x ptr addrspace(4)> [[VECTOR_DATA2]], i32 [[SORT_SIZE]], ptr addrspace(4) [[NEW_SCRATCH]], <4 x i32> splat (i32 -1))
; CHECK-NEXT:    call void @dummy_barrier.()
...
; CHECK-NEXT:    [[LLSIZE32:%.*]] = trunc i64 [[LLSIZE_P1]] to i32
; CHECK-NEXT:    [[SORT_SIZE:%.*]] = mul nuw nsw  i32 4, [[LLSIZE32]]
; CHECK-NEXT:    tail call void @_Z81__devicelib_default_work_group_private_sort_spread_ascending_p3u64_p3i16_u32_p1i8Dv8_PU3AS4mDv8_PU3AS4sjPU3AS4cDv8_j(<4 x ptr addrspace(4)> [[VECTOR_DATA1]], <4 x ptr addrspace(4)> [[VECTOR_DATA2]], i32 [[SORT_SIZE]], ptr addrspace(4) [[NEW_SCRATCH]], <8 x i32> splat (i32 -1))
; CHECK-NEXT:    call void @dummy_barrier.()
...
; CHECK:         call void @_Z18work_group_barrierj(i32 1)
; CHECK-NEXT:    tail call void @_Z72__devicelib_default_work_group_joint_sort_ascending_p3u32_p3i32_u32_p1i8Dv16_PU3AS4jDv16_PU3AS4ijPU3AS4cDv16_j(<4 x ptr addrspace(4)> [[VECTOR_DATA1]], <4 x ptr addrspace(4)> [[VECTOR_DATA2]], i32 4, ptr addrspace(4) [[NEW_SCRATCH]], <16 x i32> splat (i32 -1))
; CHECK-NEXT:    call void @dummy_barrier.()
  %broadcast.splatinsert1 = insertelement <4 x ptr addrspace(1)> poison, ptr addrspace(1) %data1, i64 0
  %broadcast.splat1 = shufflevector <4 x ptr addrspace(1)> %broadcast.splatinsert1, <4 x ptr addrspace(1)> poison, <4 x i32> zeroinitializer
  %vector.data1 = addrspacecast <4 x ptr addrspace(1)> %broadcast.splat1 to <4 x ptr addrspace(4)>
