...
; CHECK-NEXT:    store <16 x float> splat (float 1.000000e+00), ptr [[ALLOCAWGRESULT5]], align 64
; CHECK-NEXT:    [[ALLOCAWGRESULT3:%.*]] = alloca <16 x i32>, align 64
; CHECK-NEXT:    store <16 x i32> splat (i32 1), ptr [[ALLOCAWGRESULT3]], align 64
...
; CHECK-NEXT:    store float 1.000000e+00, ptr [[ALLOCAWGRESULT1]], align 4
; CHECK-NEXT:    call void @dummy_barrier.()
; CHECK-NEXT:    [[CALLWGFORITEM4:%.*]] = call <16 x i32> @_Z21work_group_reduce_mulDv16_iPS_(<16 x i32> noundef splat (i32 2), ptr [[ALLOCAWGRESULT3]])
; CHECK-NEXT:    call void @_Z18work_group_barrierj(i32 1)
...
; CHECK-NEXT:    store <16 x i32> splat (i32 1), ptr [[ALLOCAWGRESULT3]], align 64
; CHECK-NEXT:    call void @dummy_barrier.()
; CHECK-NEXT:    [[CALLWGFORITEM6:%.*]] = call <16 x float> @_Z21work_group_reduce_mulDv16_fPS_(<16 x float> noundef splat (float 2.000000e+00), ptr [[ALLOCAWGRESULT5]])
; CHECK-NEXT:    call void @_Z18work_group_barrierj(i32 1)
