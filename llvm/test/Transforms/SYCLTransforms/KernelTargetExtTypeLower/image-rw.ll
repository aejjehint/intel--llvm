...
entry:
; CHECK: define dso_local spir_kernel void @test_rw_images(ptr addrspace(1) %src1, ptr addrspace(1) %src2, ptr addrspace(1) %src3, ptr %s, ptr addrspace(3) noundef align 8 %q, <2 x i32> noundef %coords) {{.*}} !kernel_arg_target_ext_type [[MD_ARG_TARGET_EXT_TY:![0-9]+]]
