...
; Virtual function _ZN5SumOp5applyEPiN4sycl3_V17nd_itemILi1EEE is indirectly
; called by _ZTSZZ4mainENKUlRN4sycl3_V17handlerEE0_clES2_EUlT_E_.
; Check they are in the same equivalence set.
...
; CHECK-DAG: [_ZTSZZ4mainENKUlRN4sycl3_V17handlerEE0_clES2_EUlT_E_]: _ZTSZZ4mainENKUlRN4sycl3_V17handlerEE0_clES2_EUlT_E_ _ZN5SumOp5applyEPiN4sycl3_V17nd_itemILi1EEE
...
define void @_ZTSZZ4mainENKUlRN4sycl3_V17handlerEE_clES2_EUlvE_(ptr addrspace(1) nocapture writeonly align 8 %_arg_DeviceStorage) #0 !no_barrier_path !6 !spirv.ParameterDecorations !7 {
entry:
...
; Function Attrs: convergent nounwind
define internal i32 @_ZN5SumOp5applyEPiN4sycl3_V17nd_itemILi1EEE(ptr addrspace(4) nocapture readnone align 8 %this, ptr addrspace(4) nocapture %LocalData, i8 %It.coerce.high) #3 !spirv.ParameterDecorations !14 {
entry:
  call void @dummy_barrier.()
  %0 = tail call i64 @_Z12get_local_idj(i32 0) #5
