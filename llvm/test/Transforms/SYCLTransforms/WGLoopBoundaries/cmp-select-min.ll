...
; CHECK-SAME: %add0
; CHECK: Dim=1, Contains=T, IsGID=T, IsSigned=T, IsUpperBound=T
; CHECK-SAME: %add1
...
define void @cmp_select_min_kernel(ptr addrspace(1) nocapture %dst, i32 %width, i32 %height) nounwind {
