...
;     dst[gid] = gid;
; }
; icmp inst is manually modified to sle.

; CHECK:  found 1 early exit boundaries
; CHECK:    Dim=0, Contains=T, IsGID=T, IsSigned=T, IsUpperBound=T, Bound="  %to_tid_type = sext i32 %final_right_bound to i64"
...
; DEBUGIFY-COUNT-8: WARNING: Instruction with empty DebugLoc in function test
; DEBUGIFY-COUNT-32: WARNING: Instruction with empty DebugLoc in function WG.boundaries.test
