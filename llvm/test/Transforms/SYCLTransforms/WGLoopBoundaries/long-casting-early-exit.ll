...
define void @test(i64 %l, ptr addrspace(1) noalias nocapture %gl) #0 {
entry:
...
if.then:                                          ; preds = %entry
  %arrayidx = getelementptr inbounds i64, ptr addrspace(1) %gl, i64 %conv1
  %0 = load i64, ptr addrspace(1) %arrayidx, align 8
  %mul = shl nsw i64 %0, 1
  store i64 %mul, ptr addrspace(1) %arrayidx, align 8
  br label %if.end
...
; DEBUGIFY-COUNT-21: Instruction with empty DebugLoc in function WG.boundaries.
