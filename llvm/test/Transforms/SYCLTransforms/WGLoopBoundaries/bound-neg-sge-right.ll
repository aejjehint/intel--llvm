...
;     dst[gid] = gid;
; }
; icmp inst is manually modified to sge.

; CHECK:  found 1 early exit boundaries
; CHECK:    Dim=0, Contains=T, IsGID=T, IsSigned=T, IsUpperBound=F, Bound="  %to_tid_type = sext i32 %final_right_bound to i64"
...
; DEBUGIFY-COUNT-31: WARNING: Instruction with empty DebugLoc in function WG.boundaries.test
