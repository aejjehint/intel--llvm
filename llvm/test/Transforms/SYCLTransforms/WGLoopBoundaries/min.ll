...
define void @min_kernel(ptr addrspace(1) nocapture %dst, i32 %width, i32 %height) nounwind {
...
; DEBUGIFY-COUNT-33: Instruction with empty DebugLoc in function WG.boundaries.min_kernel
