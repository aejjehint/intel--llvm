...
; DEBUGIFY-COUNT-8: Instruction with empty DebugLoc in function constant_kernel
; DEBUGIFY-COUNT-32: Instruction with empty DebugLoc in function WG.boundaries.constant_kernel
