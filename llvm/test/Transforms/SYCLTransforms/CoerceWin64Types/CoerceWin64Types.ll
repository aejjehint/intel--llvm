...
; CHECK: define dso_local spir_func void @foo(i8 %0, i16 %1, i32 %2, i64 %3, ptr %4) #0 {
...
; CHECK-NEXT:  tail call spir_func void @foo(i8 %11, i16 %12, i32 %13, i64 %14, ptr %6) #2, !spirv.Decorations
; CHECK-NEXT:  ret void
define dso_local spir_func void @foo(ptr byval(%struct.A) align 1 %0, ptr byval(%struct.B) align 2 %1, ptr byval(%struct.C) align 4 %2, ptr byval(%struct.D) align 8 %3, ptr byval(%struct.E) align 8 %4) #0 {
  tail call spir_func void @foo(ptr byval(%struct.A) align 1 %0, ptr byval(%struct.B) align 2 %1, ptr byval(%struct.C) align 4 %2, ptr byval(%struct.D) align 8 %3, ptr byval(%struct.E) align 8 %4) #2, !spirv.Decorations !0
  ret void
}

; Make sure alloca memory with right addrspace.
define void @foo1(ptr addrspace(4) byval(%struct.D) align 8 %arg) #0 {
; CHECK: define void @foo1(i64 %arg) #0 {
