...
; CHECK: %lid2 = call i64 @_Z12get_local_idj(i32 2) [[ATTR:#[0-9]+]]
; CHECK: %lid1 = call i64 @_Z12get_local_idj(i32 1)
; CHECK: %lid0 = call i64 @_Z12get_local_idj(i32 0)
; CHECK: %lsz2 = call i64 @_Z14get_local_sizej(i32 2) [[ATTR]]
...
; CHECK: [[local_size:%[0-9]+]] = call i64 @_Z14get_local_sizej(i32 0) [[ATTR]]
; CHECK: %uniform.id.max = and i64 -16, %3
; CHECK: %nonuniform.size = sub i64 [[local_size]], %uniform.id.max
; CHECK: [[local_id:%[0-9]+]] = call i64 @_Z12get_local_idj(i32 0) [[ATTR]]
