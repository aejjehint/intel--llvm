...
define dso_local void @foo(ptr addrspace(1) noalias noundef %dst) #0 !kernel_arg_base_type !4 !arg_type_null_val !11 {
entry:
...
; CHECK-NEXT: call void @foo(ptr addrspace(1) noundef {{.*}}, ptr noalias %local.ids)
