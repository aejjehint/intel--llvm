...
; Below instruction missing loc info due to CMPLRLLVM-63201
; CHECK-NEXT: store i64 %dim_0_tid, ptr @__LocalIds, align 8
; CHECK-NEXT: #dbg_declare(ptr %__ocl_dbg_gid0, [[DIVarGID0:![0-9]+]], !DIExpression(), [[DILocGID:![0-9]+]]
; CHECK-NEXT: #dbg_declare(ptr %__ocl_dbg_gid1, [[DIVarGID1:![0-9]+]], !DIExpression(), [[DILocGID]]
; CHECK-NEXT: #dbg_declare(ptr %__ocl_dbg_gid2, [[DIVarGID2:![0-9]+]], !DIExpression(), [[DILocGID]]
