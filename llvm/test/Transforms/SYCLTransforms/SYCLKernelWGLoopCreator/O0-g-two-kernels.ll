...
; CHECK-NEXT: #dbg_declare(ptr %__ocl_dbg_gid0, {{.*}}, !DIExpression(),
; CHECK-NEXT: #dbg_declare(ptr %__ocl_dbg_gid1, {{.*}}, !DIExpression(),
; CHECK-NEXT: #dbg_declare(ptr %__ocl_dbg_gid2, {{.*}}, !DIExpression(),
...
; CHECK-NEXT: #dbg_declare(ptr %dst.addr, {{.*}}, !DIExpression(),
