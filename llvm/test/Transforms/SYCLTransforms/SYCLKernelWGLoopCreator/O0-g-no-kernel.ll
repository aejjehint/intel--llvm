...
; CHECK-NEXT: #dbg_declare(ptr %__ocl_dbg_gid0, !{{[0-9]+}}, !DIExpression(),
; CHECK-NEXT: #dbg_declare(ptr %__ocl_dbg_gid1, !{{[0-9]+}}, !DIExpression(),
; CHECK-NEXT: #dbg_declare(ptr %__ocl_dbg_gid2, !{{[0-9]+}}, !DIExpression(),
...
; CHECK-NEXT: #dbg_declare(ptr %dst.addr, !{{[0-9]+}}, !DIExpression(),
