...
#ifndef LLVM_TRANSFORMS_SYCLTRANSFORMS_RESOLVE_WI_CALL_H
#define LLVM_TRANSFORMS_SYCLTRANSFORMS_RESOLVE_WI_CALL_H
...
private:
  ...
  FunctionType *getOrCreatePrintfFuncType(unsigned AddrSpace);
