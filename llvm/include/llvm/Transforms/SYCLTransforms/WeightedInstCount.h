...
#ifndef LLVM_TRANSFORMS_SYCLTRANSFORMS_WEIGHTEDINSTCOUNT_H
#define LLVM_TRANSFORMS_SYCLTRANSFORMS_WEIGHTEDINSTCOUNT_H
...
public:
  ...
  InstCountResult(InstCountResult &) = delete;
  InstCountResult &operator=(InstCountResult &) = delete;
...
#endif // LLVM_TRANSFORMS_SYCLTRANSFORMS_WEIGHTEDINSTCOUNT_H
