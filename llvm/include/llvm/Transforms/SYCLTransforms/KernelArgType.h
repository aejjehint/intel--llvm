...
#ifndef LLVM_TRANSFORMS_SYCLTRANSFORMS_KERNEL_ARG_TYPE_H
#define LLVM_TRANSFORMS_SYCLTRANSFORMS_KERNEL_ARG_TYPE_H
...
enum KernelArgumentType {
  ...
  KRNL_ARG_HALF,            //!< Argument is a half.
};
...
struct KernelArgument {
  ...
  bool IsMemoryObject = false;    //!< Whther the argument is memory object.
};
