...
#ifndef LLVM_TRANSFORMS_SYCLTRANSFORMS_LOCAL_BUFF_ANALYSIS_H
#define LLVM_TRANSFORMS_SYCLTRANSFORMS_LOCAL_BUFF_ANALYSIS_H
...
public:
  ...
  LocalBufferInfo(LocalBufferInfo &) = delete;
  LocalBufferInfo &operator=(LocalBufferInfo &) = delete;
  ~LocalBufferInfo();
