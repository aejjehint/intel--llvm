...
#ifndef LLVM_TRANSFORMS_SYCLTRANSFORMS_DATA_PER_VALUE_H
#define LLVM_TRANSFORMS_SYCLTRANSFORMS_DATA_PER_VALUE_H
...
public:
  ...
  uint64_t getStrideSize(Function *F) {
...
private:
  ...
  /// \param BRI BarrierRegionInfo of the function.
  void runOnFunction(Function &F, BarrierRegionInfo &BRI);
  ...
  void collectCrossBarrierUses(Instruction *Inst, BarrierRegionInfo &BRI);
  ...
  bool crossesBarrier(Use &U, BarrierRegionInfo &BRI);
...
#endif // LLVM_TRANSFORMS_SYCLTRANSFORMS_DATA_PER_VALUE_H
