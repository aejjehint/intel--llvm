...
#ifndef LLVM_TRANSFORMS_SYCLTRANSFORMS_UTILS_FUNCTION_DESCRIPTOR_H
#define LLVM_TRANSFORMS_SYCLTRANSFORMS_UTILS_FUNCTION_DESCRIPTOR_H
...
struct FunctionDescriptor {
  ...
  // Returns the number of parameters. If there's only one parameter and its
  // type is 'void', this will return 0 instead of 1.
  size_t getNumOfParams();
...
#endif // LLVM_TRANSFORMS_SYCLTRANSFORMS_UTILS_FUNCTION_DESCRIPTOR_H
