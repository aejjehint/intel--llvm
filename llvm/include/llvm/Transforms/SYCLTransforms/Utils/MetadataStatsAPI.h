...
#ifndef LLVM_TRANSFORMS_SYCLTRANSFORMS_UTILS_METADATASTATSAPI_H
#define LLVM_TRANSFORMS_SYCLTRANSFORMS_UTILS_METADATASTATSAPI_H

#include "llvm/Transforms/SYCLTransforms/Utils/MetadataAPIImpl.h"
#include <algorithm>
...
private:
  ...
  static bool isSYCLStatKind(StringRef Kind) {
    return Kind.starts_with("sycl.stats.");
  }
