...
// Struct fields carried by sycl pipe type.
// https://github.com/intel/llvm/blob/2525570d3396225a74c2db7e17f07e5cb62c3875/sycl/include/sycl/ext/intel/experimental/pipes.hpp#L395-L403
enum ConstantPipeStorageStructField {
  Size,
  Alignment,
  Capacity,
  ReadyLatency,
...
/// Try to parse the SYCL pipe readable ClassID name from pipe storage global
/// variable name. This will return SYCLPipeStorageGVName as is if failed.
/// Example input:
///   _ZN4sycl3_V13ext5intel12experimental4pipeI9D2HPipeIDNS3_13StreamingBeat...9m_StorageE
/// Example output:
///   D2HPipeID
