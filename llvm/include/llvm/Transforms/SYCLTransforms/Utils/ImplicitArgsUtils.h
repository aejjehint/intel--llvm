...
public:
  ...
  static void getImplicitArgEnums(SmallSetVector<unsigned, 8> &ImplicitArgEnums,
                                  Module *M);

  /// Return maximum size of private memory allowed for a workitem.
  static size_t getMaxPrivateMemorySize();

  /// Return if the function need implicit arguments
  static bool needImplicitArgs(Function *Func);
...
#endif // LLVM_TRANSFORMS_SYCLTRANSFORMS_UTILS_IMPLICIT_ARGS_UTILS_H
