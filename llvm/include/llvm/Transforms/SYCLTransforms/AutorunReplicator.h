...
#ifndef LLVM_TRANSFORMS_SYCLTRANSFORMS_AUTORUN_REPLICATOR_H
#define LLVM_TRANSFORMS_SYCLTRANSFORMS_AUTORUN_REPLICATOR_H
...
#endif // LLVM_TRANSFORMS_SYCLTRANSFORMS_AUTORUN_REPLICATOR_H
